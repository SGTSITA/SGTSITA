...
@push('custom-javascript')
    ...
    <script src="{{ asset('js/sgt/proveedores/proveedores_list.js') }}?v={{ filemtime(public_path('js/sgt/proveedores/proveedores_list.js')) }}"></script>
        ...
        <form id="formCuentaGlobal" class="w-100">
            ...
            <div class="modal-content shadow-lg border-0">
                ...
                <div class="modal-body py-4 px-5">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label for="global_beneficiario" class="form-label fw-semibold">
                                Nombre del Beneficiario
                            </label>
                            <input
                                type="text"
                                class="form-control"
                                id="global_beneficiario"
