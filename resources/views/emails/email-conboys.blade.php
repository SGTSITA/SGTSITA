<div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333">
    <div style="background-color: #f1f5f9; padding: 20px; border-radius: 8px; box-shadow: 0 0 8px rgba(0, 0, 0, 0.05)">
        ...
        <div style="margin-bottom: 15px">
            <label style="font-weight: 600; color: #1e3a8a">📝 Descripcion:</label>
            <div
                id="mensajeText"
                style="background: #fff; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 5px"
            >
                {{ $mensaje ?? '' }}
            </div>
        </div>
