...
>
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form
                method="POST"
                action="{{ route('update.pagar', $item->id_cotizacion) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        ...
                                        id="total_{{ $item->id }}"
                                        name="total"
                                        value=" ${{ number_format($item->total_proveedor, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="float"
                                        class="form-control"
                                        value=" ${{ number_format($item->prove_restante, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        ...
                                        name="monto1"
                                        class="form-control"
                                        value="{{ $item->prove_monto1 }}"
                                        oninput="calcularRestante({{ $item->id }})"
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    >
                                        ...
                                        @else
                                            <option value="{{ $item->prove_metodo_pago1 }}">
                                                {{ $item->prove_metodo_pago1 }}
                                            </option>
                                        @endif
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    >
                                        @if ($item->prove_metodo_pago2 == null)
                                            <option value="">Seleccionar Metodo</option>
                                        @else
                                            <option value="{{ $item->prove_metodo_pago2 }}">
                                                {{ $item->prove_metodo_pago2 }}
                                            </option>
                                        @endif
                                        <option value="Tarjeta C/D">Tarjeta C/D</option>
                                        <option value="Transferencia">Transferencia</option>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        name="dinero_cuenta_prov"
                                        class="form-control"
                                        value="{{ $item->dinero_cuenta_prov }}"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        name="dinero_cuenta_prov2"
                                        class="form-control"
                                        value="{{ $item->dinero_cuenta_prov2 }}"
                                    />
                                </div>
                            </div>
                        </div>
