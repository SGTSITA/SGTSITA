    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            body {
                font-family:
                    Arial, Helvetica, sans-serif, 'DejaVu Sans'; /* DejaVu Sans soporta caracteres especiales en DOMPDF */
                color: var(--gris-900);
                line-height: 1.35;
                font-size: 11pt;
            }
    ...
    <body>
        ...
        <section class="tarjeta avoid-break">
            ...
            <div class="contenido">
                <dl class="dl">
                    <dt>Importador</dt>
                    <dd>{{ $subCliente->nombre }}</dd>
                    <dt>RFC</dt>
                    <dd>{{ $subCliente->rfc }}</dd>
        ...
        <section class="tarjeta avoid-break">
            ...
            <div class="contenido">
                <dl class="dl">
                    <dt>Puerto / Lugar de salida</dt>
                    <dd>{{ $cotizaciones->origen }}</dd>
                    <dt>Domicilio de entrega</dt>
                    <dd>
                        {{ $cotizaciones->direccion_entrega }}.
                        <br />
                        <span class="small">
                            Mapa:
                            <a
                                href="https://www.google.com/maps/search/?api=1&query={{ $cotizaciones->latitud }},{{ $cotizaciones->longitud }}"
                                target="_blank"
                            >
                    ...
                    <dt>Contacto (entrega)</dt>
                    <dd>{{ $cotizaciones->cp_contacto_entrega }}</dd>
                    <dt>Fecha tentativa de entrega</dt>
                    <dd>{{ $cotizaciones->cp_fecha_tentativa_entrega }}</dd>
                    <dt>Hora tentativa</dt>
                    <dd>{{ $cotizaciones->cp_hora_tentativa_entrega }}hrs</dd>
                    <dt>Comentarios</dt>
                    <dd>{{ $cotizaciones->cp_comentarios }}</dd>
                </dl>

                <div class="nota">
                    <strong class="text-azul">Nota:</strong>
        ...
        <p class="small" style="margin-top: 8px">
            Este documento se genera para fines de control logístico. Cualquier discrepancia deberá notificarse de
            inmediato al coordinador correspondiente.
        </p>
    </body>
</html>
