    ...
    <div class="contenido">
      <dl class="dl">
        ...
        <dd>
          ...
          <span class="small">Mapa: <a href="javascript:void(0);" onclick="window.open('https://www.google.com/maps/search/?api=1&query={{$cotizaciones->latitud}},{{$cotizaciones->longitud}}', '_blank')">https://www.google.com/maps/search/?api=1&query={{$cotizaciones->latitud}},{{$cotizaciones->longitud}}</a></span>
        </dd>
