                            ...
                            <div class="row">
                                <div class="col-8 offset-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="txtCliente" class="form-control" id="txtCliente" placeholder="Introduzca nombre del cliente">
                                    </div>
                                </div>
                                <div class="col-4 offset-2">
                                    <div class="mb-3">
                                        <label for="txtOrigen" class="form-label">Origen</label>
                                        <input type="text" name="txtOrigen" class="form-control" id="txtOrigen" placeholder="Introduzca Origen">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-3">
                                        <label for="txtDestino" class="form-label">Destino</label>
                                        <input type="text" name="txtDestino" class="form-control" id="txtDestino" placeholder="Introduzca Destino">
                                    </div>
                                </div>
                                <div class="col-4 offset-2">
                                    <div class="mb-3">
                                        <label for="txtContenedor" class="form-label"># Contenedor</label>
                                        <input type="text" name="txtContenedor" class="form-control" id="txtContenedor" placeholder="Introduzca # Contenedor">
                                    </div>
                                </div>
                            </div>
