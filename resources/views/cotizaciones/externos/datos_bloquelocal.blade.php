          ...
          <div class="fv-row row mb-3">
            <div class="col-6">
              <div class="input-group  mb-5">
                ...
                <div class="form-floating">
                  <input type="time" class="form-control" @if($action=="editar" ) value="{{$cotizacion->bloque_hora_i}}" @endif id="bloque_hora_i" required/>
            ...
            <div class="col-6">
              <div class="input-group  mb-5">
                ...
                <div class="form-floating">
                  <input type="time" class="form-control" @if($action=="editar" ) value="{{$cotizacion->bloque_hora_f}}" @endif id="bloque_hora_f" required />
