                ...
                <div class="mw-lg-600px mx-auto">
                    <div class="mb-13 text-center">
                        <div class="text-muted fw-semibold fs-5">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            <label
                                                ...
                                                <input type="radio" class="btn-check CheckTypeFile"
                                                    name="CheckTypeFile" checked value="BoletaLiberacion"
                                        ...
                                        <div class="col">
                                            <label
                                                ...
                                                <input type="radio" class="btn-check CheckTypeFile"
                                                    name="CheckTypeFile" value="DODA" id="btnFileDODA" />
                                        ...
                                        <div class="col">
                                            <label
                                                class="btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4">
                                                <input type="radio" class="btn-check CheckTypeFile"
                                                    name="CheckTypeFile" value="CartaPorte" id="btnFileCartaPorte" />
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            <label
                                                class="btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4">
                                                <input type="radio" class="btn-check CheckTypeFile"
                                                    name="CheckTypeFile" value="Prealta" id="btnFilePrealta" />
                            ...
                            <div class="mb-5 d-none" id="containerFolio">
                                <label class="form-label fw-semibold" id="labelFolio">
                                    Folio del documento
                                </label>
                    ...
                    <div class="scroll-y me-n7 pe-7 mt-5" id="kt_catalog_clients" data-kt-scroll="true"
