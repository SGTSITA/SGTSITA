                ...
                <div class="mw-lg-600px mx-auto">
                    ...
                    <div id="whatsAppMessageCompose" class="waElements">
                        ...
                        <div class="overflow-auto mt-10 border border-dashed border-gray-300 rounded" id="waSendFiles">
                            <div
                                class="notice d-flex bg-light-primary rounded border-primary border border-dashed mt-10 p-6"
                                id="filesNotice"
                            >
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">
                                            ...
                                            Por el momento no se pueden enviar archivos porque aún
                                            <span class="fw-bold me-1">no han sido cargados</span>
                                            al contenedor
                                        </div>
                                    </div>
                                </div>
