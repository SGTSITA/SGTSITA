      ...
      <div class="modal-body scroll-y pt-0 pb-15">
        ...
        <div class="mw-lg-600px mx-auto">
            ...
            <div id="whatsAppLogin" class="waElements">
              ...
              <div class="timeline timeline-border-dashed">
                ...
                <div class="timeline-item">
                  ...
                  <div class="mt-2 mb-8">
                    ...
                    <div class="pe-3 mb-5">
                      <!--begin::Title-->
                      <div class="fs-5 fw-semibold mb-2"> En Android, toca <a href="#" class="text-primary fw-bold me-1">Menú </a>. En iPhone, toca <a href="#" class="text-primary fw-bold me-1">Ajustes</a>
                      </div>
                      <!--end::Title-->
                ...
                <div class="timeline-item">
                  ...
                  <div class="mt-2 mb-6">
                    ...
                    <div class="pe-3 mb-5">
                      <!--begin::Title-->
                      <div class="fs-5 fw-semibold mb-2"> Toca, <a href="#" class="text-primary fw-bold me-1">Dispositivos vinculados</a> y, luego <a href="#" class="text-primary fw-bold me-1">Vincular Dispositivo</a>
                      </div>
                      <!--end::Title-->
                ...
                <div class="timeline-item">
                  ...
                  <div class="mt-2 mb-6">
                    ...
                    <div class="pe-3 mb-5">
                      <!--begin::Title-->
                      <div class="fs-5 fw-semibold mb-2"> Escanea el código QR para confirmar </div>
                      <!--end::Title-->
              ...
              <div class="">
                <div class="symbol symbol-150px symbol-lg-160px ">
                    <img id="WhatsAppQrPicture" src="/assets/metronic/media/patterns/pattern-1.jpg" alt="image">
                </div>
            </div>
              </div>
            </div>
          ...
          <div class="mt-10 mb-10">
            ...
            <!--begin::Title-->
            <div class="d-flex">
              <input id="kt_whatsapp_text_input" type="text" placeholder="Escriba un mensaje..." class="form-control form-control-solid me-3 flex-grow-1" autocomplete="off" name="waMessage" />
