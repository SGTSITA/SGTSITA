                        ...
                        <div class="col-3">
                            <div class="input-group mb-5">
                                ...
                                <div class="form-floating">
                                    ...
                                    />
                                    <label for="cp_fecha_tentativa_entrega" class="text-gray-700">
                                        Fecha tentativa entrega
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <div class="input-group mb-5">
                                ...
                                <div class="form-floating">
                                    ...
                                    />
                                    <label for="cp_hora_tentativa_entrega" class="text-gray-700">
                                        Hora tentativa entrega
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <select class="form-select id_uso_cfdi d-inline-block" id="id_uso_cfdi" name="id_uso_cfdi">
                                ...
                                @foreach ($usoCfdi as $u)
                                    <option
                                        value="{{ $u->id }}"
                                        @if ($action == "editar")
                                            @if ($u->id == $cotizacion->sat_uso_cfdi_id)
                                                selected
                                            @endif
                                        @endif
                                    >
                                        {{ $u->sat_code }} - {{ $u->uso_cfdi }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            >
                                ...
                                @foreach ($formasPago as $f)
                                    <option
                                        value="{{ $f->id }}"
                                        @if ($action == "editar")
                                            @if ($f->id == $cotizacion->sat_forma_pago_id)
                                                selected
                                            @endif
                                        @endif
                                    >
                                        {{ $f->sat_code }} - {{ $f->forma_pago }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            >
                                ...
                                @foreach ($metodosPago as $m)
                                    <option
                                        value="{{ $m->id }}"
                                        @if ($action == "editar")
                                            @if ($m->id == $cotizacion->sat_metodo_pago_id)
                                                selected
                                            @endif
                                        @endif
                                    >
                                        {{ $m->sat_code }} - {{ $m->metodo_pago }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
