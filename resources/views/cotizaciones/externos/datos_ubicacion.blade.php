...
<div class="col-12">
	...
	<div class="input-group" >
		...
		<textarea class="form-control" value ="d" name="direccion_entrega" id="direccion_entrega" aria-label="Dirección Entrega">
            @if($action == "editar") {{$cotizacion->direccion_entrega}} @endif</textarea>
  </div>
</div>
--}}
<div class="col-12">
  <div class="position-relative mb-6">
    <textarea name="direccion_entrega" data-bs-toggle="modal" data-bs-target="#mapModal" id="direccion_entrega" readonly aria-label="Dirección Entrega" class="form-control border-0 p-0 pe-10 resize-none min-h-25px" data-kt-autosize="true" rows="1" placeholder="Seleccione ubicación GSP..." data-kt-initialized="1" style="overflow: hidden; overflow-wrap: break-word; text-align: start; height: 25px;">@if($action == "editar") {{trim($cotizacion->direccion_entrega)}} @endif</textarea>
    <div class="position-absolute top-0 end-0 me-n5">
      <button class="btn btn-sm btn-light-primary btn-flex btn-center" data-bs-toggle="modal" data-bs-target="#mapModal">
  ...
  <textarea class="form-control" placeholder="Dirección entrega">@if($action == "editar") {{trim($cotizacion->direccion_entrega)}} @endif</textarea>
