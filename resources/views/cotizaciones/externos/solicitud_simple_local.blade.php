...
@section('WorkSpace')
    <style>
        ...
        .total-general-floating {
            ...
            right: 25px;
            bottom: 40px;
            /* 👈 antes era top, ahora controlamos posición vertical desde abajo */
            z-index: 10;
        }
        ...
        .color-select.verde {
            background-color: #6EE74F !important;
        }
        ...
        <div class="card-header card-header-stretch pb-0">
                ...
                <ul class="nav nav-stretch nav-line-tabs border-transparent" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a id="kt_billing_creditcard_tab" class="nav-link fs-5 fw-bold me-5 active" data-bs-toggle="tab"
                            href="#kt_billing_creditcard" role="tab" aria-selected="true">
                            Datos Generales
                        </a>
                    </li>
          ...
          <a id="kt_billing_paypal_tab" class="nav-link fs-5 fw-bold"
            ...
            Ubicación GPS
                    ...
                    <li class="nav-item" role="presentation">
                        <a id="kt_bloque_tab" class="nav-link fs-5 fw-bold" data-bs-toggle="tab" href="#kt_bloque"
                    ...
                    <li class="nav-item" role="presentation">
                        <a id="kt_documentos_tab" class="nav-link fs-5 fw-bold" data-bs-toggle="tab" href="#kt_documentos"
                            role="tab" aria-selected="false">
                            Documentos
                        </a>
                    </li>
...
@push('javascript')
    ...
    <script
        src="{{ asset('js/sgt/cotizaciones/cotizaciones-local.js') }}?v={{ filemtime(public_path('js/sgt/cotizaciones/cotizaciones-local.js')) }}">
    </script>
    ...
    <script
        src="{{ asset('js/sgt/cotizaciones/cotizaciones-local-fileuploader-preload.js') }}?v={{ filemtime(public_path('js/sgt/cotizaciones/cotizaciones-local-fileuploader-preload.js')) }}">
    </script>
    <script src="{{ asset('js/sgt/common/tagify.js') }}?v={{ filemtime(public_path('js/sgt/common/tagify.js')) }}">
    </script>
    <script
        src="{{ asset('assets/metronic/fileuploader/cotizacion-cliente-externo-local.js') }}?v={{ filemtime(public_path('js/sgt/cotizaciones/cotizaciones-local.js')) }}">
    </script>
    <script
        ...
        $(document).ready(() => {
            ...
            function aplicarColor() {
                ...
                switch (selectEstado.value) {
                    case "VERDE":
                        selectEstado.classList.add('verde');
                        break;
                    case "AMARILLO":
                        selectEstado.classList.add('amarillo');
                        break;
                    case "ROJO":
                        selectEstado.classList.add('rojo');
                        break;
                    case "OVT":
                        selectEstado.classList.add('ovt');
                        break;
                }
            }
