      ...
      <div class="fv-row row mb-3">
        <div class="col-6">
          <div class="input-group  mb-5">
            ...
            <div class="form-floating">
              <input type="text" class="form-control" autocomplete="off" id="num_contenedor" placeholder="" @if($action=="editar" ) value="{{$cotizacion->DocCotizacion->num_contenedor}}" @endif oninput="changeTag('tagContenedor',this.value)" />
