...
<div class="fv-row row mb-3">
    ...
    <div class="col-2">
        <div class="input-group mb-5">
            ...
            <div class="form-floating">
                <input
                    @if ($action == 'editar') value="{{ $cotizacion->origen_local }}" @endif
                    type="text"
                    class="form-control"
                    id="origen"
                    autocomplete="off"
    ...
    <div class="col-2">
        <div class="input-group mb-5">
            ...
            <div class="form-floating">
                <input
                    @if ($action == 'editar') value="{{ $cotizacion->destino_local }}" @endif
                    type="text"
                    class="form-control"
                    id="destino"
                    autocomplete="off"
...
<div class="fv-row row mb-3">
    ...
    <div class="col-2">
        <div class="input-group mb-5">
            ...
            <div class="form-floating">
                <input
                    @if ($action == 'editar') value="{{ $cotizacion->fecha_modulacion_local }}" @endif
                    type="text"
