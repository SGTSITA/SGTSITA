                    ...
                    <div class="col-12 mb-5">
                        ...
                        <select class="form-select subcliente d-inline-block" id="id_transportistalocal"
                            ...
                            @foreach ($transportista as $tr)
                                <option value="{{ $tr->id }}" @if ($action == 'editar' && $cotizacion?->transportista_local == $tr->id) selected @endif>
                                    {{ $tr->nombre }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="form-floating flex-grow-1">
                <select id="estado_contenedor" name="estado_contenedor" class="form-select color-select">
                    ...
                    @foreach ($opcionesColores as $color)
                        <option value="{{ $color }}" @if ($action == 'editar' && $cotizacion->estado_contenedor == $color) selected @endif>
                            {{ $color }}
                        </option>
                    @endforeach
                </select>
    ...
    <div class="col-4 d-none">
        <div class="input-group mb-5">
            ...
            <div class="form-floating">
                ...
                <input type="text" class="form-control" autocomplete="off" id="precio_sobre_peso" placeholder=""
                    value="0" oninput="allowOnlyDecimals(event)" />
                <input type="text" class="form-control" autocomplete="off" id="precio_tonelada" placeholder=""
                    value="0" oninput="allowOnlyDecimals(event)" />
            </div>
        </div>
    </div>
...
<div class="fv-row row mb-3">
    ...
    <div class="col-2">
        <div class="input-group mb-5">
            ...
            <div class="form-floating flex-grow-1">
                <input @if ($action == 'editar') value="{{ $cotizacion->cp_pedimento }}" @endif type="text"
                    class="form-control" autocomplete="off" id="num_pedimento" name="num_pedimento"
                    placeholder="" />
        ...
        <div class="input-group mb-5">
            ...
            <div class="form-floating flex-grow-1 d-flex align-items-center ps-4">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="confirmacion_sello"
...
<div class="fv-row row mb-3">
        ...
        <div class="input-group mb-5">
            ...
            <div class="form-floating flex-grow-1">
                <input type="text" id="Costomaniobra" name="Costomaniobra" class="form-control fw-bold"
                    @if ($action == 'editar') value="{{ $cotizacion->costo_maniobra_local }}" @endif
                    oninput="allowOnlyDecimals(event)" />
    ...
    <div class="col-2">
        <div class="input-group mb-5">
            ...
            <div class="form-floating flex-grow-1">
                <input type="text" id="agente_aduanal" name="agente_aduanal" class="form-control fw-bold"
                    @if ($action == 'editar') value="{{ $cotizacion->agente_aduanal }}" @endif />
                <label for="agente_aduanal" class="text-gray-700">Agente Aduanal</label>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-2">
            <div class="col-md-4">
                ...
                <input type="number" id="tarifa_pernocta" name="tarifa_pernocta" class="form-control"
                    @if ($action == 'editar') value="{{ $cotizacion->tarifa_pernocta }}" @endif />
            </div>
            <div class="col-md-4">
                <label>Noches</label>
                <input type="number" id="dias_pernocta" name="dias_pernocta" class="form-control"
                    @if ($action == 'editar') value="{{ $cotizacion->dias_pernocta }}" @endif />
            </div>
            <div class="col-md-4">
                <label>Total Pernocta ($)</label>
                <input type="text" id="total_pernocta" name="total_pernocta" class="form-control fw-bold"
                    readonly @if ($action == 'editar') value="{{ $cotizacion->total_pernocta }}" @endif />
            </div>
        </div>
        ...
        <div class="row mt-3 border-top pt-3 bg-light rounded">
            <div class="col-12 text-center">
                ...
                <input type="text" id="total_general" name="total_general"
                    ...
                    @if ($action == 'editar') value="{{ $cotizacion->total_general }}" @endif readonly />
            </div>
        </div>
    </div>
</div>
