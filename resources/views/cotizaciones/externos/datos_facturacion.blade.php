            ...
            <div class="col-3">
              <div class="input-group  mb-5">
                  ...
                  <div class="form-floating">
                      <input @if ($action == 'editar') value="" @endif type="text"
                          class="form-control" id="destino" autocomplete="off" placeholder="" />
                      <label for="destino" class="text-gray-700">Pedimento</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-3">
              <div class="input-group  mb-5">
                  ...
                  <div class="form-floating">
                      <input @if ($action == 'editar') value="" @endif type="text"
                          class="form-control" id="destino" autocomplete="off" placeholder="" />
                      <label for="destino" class="text-gray-700">Clave SAT</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-3">
              <div class="input-group  mb-5">
                  ...
                  <div class="form-floating">
                      <input @if ($action == 'editar') value="" @endif type="text"
                          class="form-control" id="destino" autocomplete="off" placeholder="" />
                      <label for="destino" class="text-gray-700">Clase Ped</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-3">
              <div class="input-group  mb-5">
                  ...
                  <div class="form-floating">
                      <input @if ($action == 'editar') value="" @endif type="text"
                          class="form-control" id="destino" autocomplete="off" placeholder="" />
                      <label for="destino" class="text-gray-700">Cantidad</label>
                  </div>
              </div>
            </div>
            ...
            <div class="col-3">
              <div class="input-group  mb-5">
                  ...
                  <div class="form-floating">
                      <input @if ($action == 'editar') value="" @endif type="text"
                          class="form-control" id="destino" autocomplete="off" placeholder="" />
                      <label for="destino" class="text-gray-700">Valor</label>
                  </div>
              </div>
            </div>
