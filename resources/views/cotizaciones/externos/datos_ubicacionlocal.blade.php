<div class="col-12">
    <div class="position-relative mb-6">
        <textarea
            ...
            rows="1"
            placeholder="Seleccione ubicación GSP..."
...
@if ($action == 'editar')
 {{ trim($cotizacion->direccion_entrega) }} @endif
    ...
    >
    <input
        @if($action=="editar" ) value="{{ $cotizacion->latitud }}" @endif
        class="form-control"
        type="hidden"
        name="latitud"
        id="latitud"
    />
    <input
        @if($action=="editar" ) value="{{ $cotizacion->longitud }}" @endif
        class="form-control"
        type="hidden"
        name="longitud"
        id="longitud"
    />
    <input
        @if($action=="editar" ) value="{{ $cotizacion->direccion_mapa }}" @endif
        class="form-control"
        type="hidden"
        name="direccion_mapa"
        id="direccion_mapa"
    ...
    />
    <input
        @if($action=="editar" ) value="{{ $cotizacion->fecha_seleccion_ubicacion }}" @endif
        class="form-control"
        type="hidden"
...
<div class="col-12">
    ...
    <div class="nav bg-light rounded-pill px-3 py-2 ms-9 mb-5 w-225px" data-kt-buttons="true">
        <!--begin::Nav link-->
        <div
            class="recinto nav-link btn btn-active btn-active-primary fw-bold btn-color-gray-600 @if($action == 'editar') @if(intval($cotizacion->uso_recinto) == 0) active @endif @else active @endif py-3 px-5 m-1 rounded-pill"
        ...
        <!--begin::Nav link-->
        <div
            class="recinto nav-link btn btn-active btn-active-primary fw-bold btn-color-gray-600 @if($action == 'editar') @if(intval($cotizacion->uso_recinto) == 1) active @endif @endif py-3 px-5 m-1 rounded-pill"
    ...
    <div
        class="input-group @if($action == 'editar') @if(intval($cotizacion->uso_recinto) == 0) d-none @endif @else d-none @endif"
        id="input-recinto"
    >
