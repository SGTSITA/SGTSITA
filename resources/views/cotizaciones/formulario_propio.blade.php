<div class="row">
    <div class="col-6 form-group">
        ...
        <div class="input-group">
            ...
            <input
                id="fecha_inicio_{{ $cotizacion->id }}"
                name="fecha_inicio"
                type="date"
                class="form-control"
                value="{{ \Carbon\Carbon::parse($cotizacion->DocCotizacion->Asignaciones->fecha_inicio)->format('Y-m-d') }}"
            />
        </div>
    </div>
    ...
    <div class="col-6 form-group">
        ...
        <div class="input-group">
            ...
            <input
                id="fecha_fin_{{ $cotizacion->id }}"
                name="fecha_fin"
                type="date"
                class="form-control"
                value="{{ \Carbon\Carbon::parse($cotizacion->DocCotizacion->Asignaciones->fecha_fin)->format('Y-m-d') }}"
            />
        </div>
    </div>
    ...
    @if ($cotizacion->DocCotizacion->Asignaciones->id_camion == null)
        <button
            class="btn"
            type="button"
            id="btn_clientes_search{{ $cotizacion->id }}"
    ...
    @if ($cotizacion->DocCotizacion->Asignaciones->id_proveedor == null)
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select d-inline-block" id="camion" name="camion" value="{{ old('camion') }}">
                        ...
                        @else
                            <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_camion }}">
                                {{ $cotizacion->DocCotizacion->Asignaciones->Camion->folio }} /
                                {{ $cotizacion->DocCotizacion->Asignaciones->Camion->modelo }}
                            </option>
                        @endif
                ...
                <div class="input-group mb-3">
                    ...
                    >
                        @if ($cotizacion->DocCotizacion->Asignaciones->id_operador == null)
                            <option value="">Seleccione opcion</option>
                        @else
                            <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_operador }}">
                                {{ $cotizacion->DocCotizacion->Asignaciones->Operador->nombre }} /
                                {{ $cotizacion->DocCotizacion->Asignaciones->Operador->telefono }}
                            </option>
                        @endif
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select d-inline-block" id="chasis" name="chasis" value="{{ old('chasis') }}">
                        @if ($cotizacion->DocCotizacion->Asignaciones->id_chasis == null)
                            <option value="">Seleccione opcion</option>
                        @else
                            <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_chasis }}">
                                {{ $cotizacion->DocCotizacion->Asignaciones->Chasis->folio }} /
                                {{ $cotizacion->DocCotizacion->Asignaciones->Chasis->modelo }}
                            </option>
                        @endif
        ...
        <div class="col-12 form-group" id="chasisAdicional1Group" style="display: none">
            ...
            <select
                class="form-select d-inline-block"
                id="chasisAdicional1"
                name="chasisAdicional1"
                value="{{ old('chasisAdicional1') }}"
            >
                @if ($cotizacion->DocCotizacion->Asignaciones->id_chasis2 == null)
                    <option value="">Seleccione opcion</option>
                @else
                    <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_chasis2 }}">
                        {{ $cotizacion->DocCotizacion->Asignaciones->Chasis2->folio }} /
                        {{ $cotizacion->DocCotizacion->Asignaciones->Chasis2->modelo }}
                    </option>
                @endif
        ...
        <div class="col-12 form-group" id="nuevoCampoDolyGroup" style="display: none">
            ...
            <select
                ...
                id="nuevoCampoDoly"
                name="nuevoCampoDoly"
                value="{{ old('nuevoCampoDoly') }}"
            >
                @if ($cotizacion->DocCotizacion->Asignaciones->id_dolys == null)
                    <option value="">Seleccione opcion</option>
                @else
                    <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_dolys }}">
                        {{ $cotizacion->DocCotizacion->Asignaciones->Doly->folio }} /
                        {{ $cotizacion->DocCotizacion->Asignaciones->Doly->modelo }}
                    </option>
                @endif
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input
                        ...
                        type="text"
                        class="form-control"
                        value="{{ $cotizacion->DocCotizacion->Asignaciones->sueldo_viaje }}"
                    />
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input
                        ...
                        type="text"
                        class="form-control"
                        value="{{ $cotizacion->DocCotizacion->Asignaciones->dinero_viaje }}"
                    />
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select
                        ...
                        data-toggle="select"
                        id="id_banco1_dinero_viaje"
                        name="id_banco1_dinero_viaje"
                        value="{{ old('id_banco1_dinero_viaje') }}"
                    >
                        @if ($cotizacion->DocCotizacion->Asignaciones->id_banco1_dinero_viaje == null)
                            <option value="">Seleccione opcion</option>
                        @else
                            <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_banco1_dinero_viaje }}">
                                {{ $cotizacion->DocCotizacion->Asignaciones->Banco1->nombre_banco }} -
                                ${{ number_format($cotizacion->DocCotizacion->Asignaciones->Banco1->saldo, 2, '.', ',') }}
                            </option>
                        @endif
        ...
        <div class="col-6 form-group" id="operadorGroup">
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input
                        name="cantidad_banco1_dinero_viaje"
                        id="cantidad_banco1_dinero_viaje"
                        type="number"
                        class="form-control"
                        value="{{ $cotizacion->DocCotizacion->Asignaciones->cantidad_banco1_dinero_viaje }}"
                    />
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select
                        class="form-select cliente d-inline-block"
                        data-toggle="select"
                        id="id_banco2_dinero_viaje"
                        name="id_banco2_dinero_viaje"
                        value="{{ old('id_banco2_dinero_viaje') }}"
                    >
                        @if ($cotizacion->DocCotizacion->Asignaciones->id_banco2_dinero_viaje == null)
                            <option value="">Seleccione opcion</option>
                        @else
                            <option value="{{ $cotizacion->DocCotizacion->Asignaciones->id_banco2_dinero_viaje }}">
                                {{ $cotizacion->DocCotizacion->Asignaciones->Banco2->nombre_banco }} -
                                ${{ number_format($cotizacion->DocCotizacion->Asignaciones->Banco2->saldo, 2, '.', ',') }}
                            </option>
                        @endif
                        @foreach ($bancos as $item)
                            <option value="{{ $item->id }}">
        ...
        <div class="col-6 form-group" id="operadorGroup">
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input
                        name="cantidad_banco2_dinero_viaje"
                        id="cantidad_banco2_dinero_viaje"
                        type="number"
                        class="form-control"
                        value="{{ $cotizacion->DocCotizacion->Asignaciones->cantidad_banco2_dinero_viaje }}"
                    />
                </div>
            </div>
        </div>
