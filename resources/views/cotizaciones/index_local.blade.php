                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center">
                            <span id="card_title">Solicitudes Maniobra local</span>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Carga de Documentos Contenedor
                        <span id="numContenedorcargar"></span>
                    </h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <hr />
                        <div id="maniobra_documentos" class="d-flex flex-wrap gap-3 justify-content-center">
                            Sin documentos
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer pdf-ignore">
                    <button class="btn btn-outline-danger" id="btnExportPDF">
                        <i class="ki-duotone ki-file-pdf fs-3"></i>
                        Exportar PDF
                    </button>
            ...
            `;
                    ...
                    upload: {
                        ...
                        onProgress: function (data, item) {
                            ...
                            item.html.find('.fileuploader-progressbar .bar').css('width', progreso + '%');

                            item.html.find('.progress-text').html(progreso + '%');
                        },
