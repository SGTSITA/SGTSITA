                                ...
                                >
                                    <div class="row">
                                        ...
                                        <h6 class="mb-2 text-md labelNumContedor" id="labelNumContenedor-3">
                                            Núm contenedor: {{ $documentacion->num_contenedor }}
                                        </h6>
                                        ...
                                        >
                                                    ...
                                                    >
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <span class="mb-2 text-md">
                                                                ...
                                                                GPS:
                                                                <span class="text-dark font-weight-bold ms-2">
                                                                    {{ optional(optional(optional($documentacion->Asignaciones)->Camion)->gps)->nombre }}
                                                                    /
                                                                    {{ $documentacion->Asignaciones?->Camion?->imei }}
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </li>
                                            ...
                                            @can('cotizacion-valores')
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 form-group">
                                                        <label for="name">
                                                            Total tonelada {{ $cotizacion->sobrepeso }}
                                                        </label>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text" id="basic-addon1">
                                                                <img
