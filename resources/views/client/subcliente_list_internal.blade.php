        ...
        <div class="row">
         ...
         <div class="col-6 text-end">
          <form action="{{route('new.subcliente')}}" method="post">
            ...
            <button type="submit" class="btn btn-sm bg-gradient-info me-3">Agregar SubCliente</button>
          </form>
         ...
         <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="mb-2 text-md">Nombre: <span class="text-dark font-weight-bold ms-sm-2">{{$client->nombre}}</span></span>
                    <span class="mb-2 text-md">SubClientes: <span class="text-dark ms-sm-2 font-weight-bold" id="countSubclientes">0</span></span>
