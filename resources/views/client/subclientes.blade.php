        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('update_subclientes.clientes', $subcliente->id) }}"
                            id="" enctype="multipart/form-data" role="form">
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="regimen_fiscal" id="regimen_fiscal" type="text" class="form-control"
                                            value="{{ $subcliente->regimen_fiscal }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="nombre_empresa" id="nombre_empresa" type="text"
                                            class="form-control" value="{{ $subcliente->nombre_empresa }}">
                                    </div>
                                </div>
