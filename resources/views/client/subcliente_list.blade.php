...
@section('WorkSpace')
            ...
            <div class="card card-flush h-lg-100">
                <div class="card-header ">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-gray-500 mt-1 fw-semibold fs-6">Lista de <span class="text-gray-600 fw-bold">Sub
                                Clientes</span> </span>
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div id="agGridSubClientes" class="ag-theme-quartz" style="height: 500px;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    @push('javascript')
        ...
        <script
            src="{{ asset('js/sgt/clientes/subclientes_list.js') }}?v={{ filemtime(public_path('js/sgt/clientes/subclientes_list.js')) }}">
        </script>
        <script
