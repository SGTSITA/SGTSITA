                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <a class="btn" href="{{ route('index.cobrar') }}"
                                style="background: {{ $configuracion->color_boton_close }}; color: #ffff;margin-right: 3rem;">
                                <img src="{{ asset('img/icon/izquierda_white.png') }}" alt="" width="25px">
                                Regresar
                            </a>
                        </div>
                        <h3 class="text-center">{{ $cliente->nombre }}</h3>

                        <a class="btn btn_filter" data-bs-toggle="collapse" href="#collapseFilter" role="button"
                            aria-expanded="false" aria-controls="collapseFilter">
                            <img class="icon_search" src="{{ asset('img/icon/depositar.png') }}" alt=""
                                width="25px"> Cobrar varios
                        </a>
                        ...
                        <div class="collapse container_filter " id="collapseFilter" style="background: #ffffff;">
                            <form method="POST" action="{{ route('update_varios.cobrar') }}" enctype="multipart/form-data"
                                role="form">
                                @csrf
                                <div class="row">
                                    <input type="hidden" id="id_cliente" name="id_cliente" value="{{ $cliente->id }}">
                                    <div class="col-3" style="    display: grid;">
                                        <select class="form-control cotizaciones" name="id_cotizacion[]" id="id_cotizacion"
                                            multiple>
                                            @foreach ($cotizacionesPorPagar as $item)
                                                <option value="{{ $item->id }}" data-total="{{ $item->restante }}"
                                                    data-numcontenedor="{{ $item->DocCotizacion->num_contenedor }}">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" type="text" name="total_sum" id="total_sum"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" type="text" name="remaining_total"
                                                    id="remaining_total" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="float" id="monto1_varios" name="monto1_varios"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">
                                                    <img src="{{ asset('img/icon/metodo-de-pago.webp') }}" alt=""
                                                        width="25px">
                                                </span>
                                                <select class="form-select cliente d-inline-block" data-toggle="select"
                                                    id="metodo_pago1_varios" name="metodo_pago1_varios"
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select cliente d-inline-block" data-toggle="select"
                                                    id="id_banco1_varios" name="id_banco1_varios"
                                                    value="{{ old('id_banco1') }}">
                                                    <option value="">Selecciona</option>
                                                    @foreach ($bancos as $item)
                                                        <option value="{{ $item->id }}">{{ $item->nombre_banco }} -
                                                            ${{ $item->saldo }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1">
                                                    <img src="{{ asset('img/icon/validando-billete.webp') }}"
                                                        alt="" width="25px">
                                                </span>
                                                <input type="file" id="comprobante1_varios" name="comprobante1_varios"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="float" id="monto2_varios" name="monto2_varios"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select cliente d-inline-block" data-toggle="select"
                                                    id="metodo_pago2_varios" name="metodo_pago2_varios"
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select cliente d-inline-block" data-toggle="select"
                                                    id="id_banco2_varios" name="id_banco2_varios"
                                                    value="{{ old('id_banco2') }}">
                                                    <option value="">Selecciona</option>
                                                    @foreach ($bancos as $item)
                                                        <option value="{{ $item->id }}">{{ $item->nombre_banco }} -
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="file" id="comprobante2_varios" name="comprobante2_varios"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" type="text" name="remaining_abonos"
                                                    id="remaining_abonos" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <button class="btn " type="submit"
                                            style="background-color: #babd24; color: #ffffff;">Cobrar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <table class="table table-striped table-hover table_id" id="datatable-search">
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th><img src="{{ asset('img/icon/bolsa-de-dinero.webp') }}" alt=""
                                                width="25px">Total a pagar</th>
                                        <th><img src="{{ asset('img/icon/gps.webp') }}" alt=""
                                                width="25px">Tipo de viaje</th>
                                        <th><img src="{{ asset('img/icon/semaforos.webp') }}" alt=""
                                                width="25px">Estatus</th>
                                        <th><img src="{{ asset('img/icon/edit.png') }}" alt=""
                                                width="25px">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($cotizacionesPorPagar as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-success" data-bs-toggle="modal"
