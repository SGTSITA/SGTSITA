...
>
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form
                method="POST"
                action="{{ route('update.cobrar', $item->id) }}"
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->precio_viaje, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->burreo, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->maniobra, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->estadia, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->otro, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->iva, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="col-6 form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="${{ number_format($item->retencion, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        name="restante"
                                        value=" ${{ number_format($item->restante, 2, '.', ',') }}"
                                        readonly
                                    />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    >
                                        ...
                                        @else
                                            <option value="{{ $item->metodo_pago1 }}">
                                                {{ $item->metodo_pago1 }}
                                            </option>
                                        @endif
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    >
                                        @if ($item->metodo_pago2 == null)
                                            <option value="">Seleccionar Metodo</option>
                                        @else
                                            <option value="{{ $item->metodo_pago2 }}">
                                                {{ $item->metodo_pago2 }}
                                            </option>
                                        @endif
                                        <option value="Tarjeta C/D">Tarjeta C/D</option>
