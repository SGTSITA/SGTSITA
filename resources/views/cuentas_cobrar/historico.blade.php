                    ...
                    <div class="card-header pb-0">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <a href="{{ route('cobros_pagos.exportar_excel', array_merge(request()->all(), ['tipo' => 'cxc'])) }}" class="btn btn-sm btn-outline-success mb-0">
                                    <i class="fas fa-file-excel"></i> Excel
                                </a>
                                <a href="{{ route('cobros_pagos.exportar_pdf', array_merge(request()->all(), ['tipo' => 'cxc'])) }}" class="btn btn-sm btn-outline-danger mb-0">
                                    <i class="fas fa-file-pdf"></i> PDF
                                </a>
                                @if(request('cliente_id'))
                                    <a class="btn btn-sm btn-secondary mb-0" href="{{ route('show.cobrar', request('cliente_id')) }}">
                    ...
                    <div class="card-body pt-2">
                        ...
                        <form method="GET" action="{{ route('cobros_pagos.historico') }}" class="mb-4">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3 mb-2">
                                    <label for="proveedor_id" class="form-label text-sm mb-1">Proveedor (Asignaciones)</label>
                                ...
                                <div class="col-md-1 mb-2 d-flex gap-2">
                                    ...
                                    <a href="{{ route('cobros_pagos.historico') }}" class="btn btn-sm btn-outline-secondary mb-0 p-2 btn-reset-filter" title="Quitar filtros" data-bs-toggle="tooltip" data-bs-placement="top">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-sm align-middle text-sm" style="font-size: 0.85rem;">
                                ...
                                <tbody>
                                        ...
                                        <tr class="collapse" id="collapsePago{{ $pago->id }}">
                                            <td colspan="10" class="bg-light p-3">
                                                <div class="card card-body shadow-none border m-0">
                                                    <h6 class="mb-2">Cotizaciones vinculadas al Cobro #{{ $pago->id }}</h6>
                                                    <div class="table-responsive">
                                                            ...
                                                            <tbody>
                                                                @forelse($pago->detalles as $detalle)
                                                                    <tr>
                                                                        ...
                                                                        <td>${{ number_format($detalle->cotizacion->total ?? 0, 2) }}</td>
                                                                    </tr>
                                                                @empty
                                                                    <tr>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center">No se encontraron registros de cobros.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
