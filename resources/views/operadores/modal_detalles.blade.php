<div
    class="modal fade"
    id="operadoresModal_detalles{{ $item->id }}"
    tabindex="-1"
    aria-labelledby="operadoresModal_detalles{{ $item->id }}Label"
    aria-hidden="true"
>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-3 form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            class="form-control"
                                            value="{{ $item->dinero_viaje - $item->sueldo_viaje - $item->gasolina - $item->casetas - $item->otros }}"
                                            readonly
                                        />
                                    </div>
                                </div>
                                ...
                                <div class="col-4 form-group">
                                    <h5 for="name">Comprobante gasolina</h5>
                                    <br />
                                    @foreach ($comprobantes_gasolina as $comprobante)
                                        @if ($item->id == $comprobante->id_asignacion)
                                            <a
                                                href="{{ asset('comprobantes/' . $comprobante->imagen) }}"
                                                data-lightbox="example-2"
                                                data-title="{{ $comprobante->tipo }}"
                                                target="_blank"
                                            >
                                                <img
                                                    src="{{ asset('comprobantes/' . $comprobante->imagen) }}"
                                                    alt=""
                                                    width="100px"
                                                />
                                            </a>
                                ...
                                <div class="col-4 form-group">
                                    <h5 for="name">Comprobante casetas</h5>
                                    <br />
                                ...
                                <div class="col-4 form-group">
                                    <h5 for="name">Comprobante otros</h5>
                                    <br />
