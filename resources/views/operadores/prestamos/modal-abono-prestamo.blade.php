        ...
        <form id="formAbono">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="number" step="0.01" min="0.01" class="form-control border-start-0" id="monto_abono" required>
            </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="referencia" name="referencia" maxlength="150" placeholder="Ingrese una referencia para el abono">
            <div class="invalid-feedback">La referencia no debe exceder los 150 caracteres.</div>
          </div>

          <div class="text-end mt-4">
            <button type="submit" class="btn btn-success px-4">
              <i class="bi bi-cash-coin me-1"></i> Guardar abono
            </button>
          </div>
        </form>
      </div>
