...
<html lang="es">
  <head>
    <base href="/" />
    <title>Modulo externo de Proveedores</title>
    <meta charset="utf-8" />
      ...
      <div class="page d-flex flex-row flex-column-fluid">
        <div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
          <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
            <a href="/home">
              <span class="badge bg-primary text-white fs-6 px-3 py-2">MEP</span>
              <!-- <img alt="Logo" src="/assets/images/mep.jpg" class="h-25px logo theme-light-show" />
              <img alt="Logo" src="/assets/images/mep.jpg" class="h-25px logo theme-dark-show" /> -->
            </a>
          </div>
                  ...
                  <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                      <a href="{{route('configmec')}}" class="menu-link">
                        ...
                        <span class="menu-title">Ver facturas clientes</span>
                      </a>
                    </div>
                  </div>
                </div>
