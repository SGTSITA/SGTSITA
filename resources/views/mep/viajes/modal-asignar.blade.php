          ...
          <h6>Datos de la Unidad
            ...
            <div class="col-md-4">
              ...
              <div class="position-relative w-100">
                ...
                >
                <!-- Icono convertido en botón -->
                <button type="button" class="btn btn-sm position-absolute end-0 top-50 translate-middle-y me-2 p-1 rounded-circle " onclick="buscarUnidad(txtNumUnidad.value,'Unidad')">
                  <i class="fas fa-search "></i>
                </button>
              </div>
            </div>
...
<ul class="nav nav-tabs mb-3" id="chasisTabs" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="chasisB-tab" data-bs-toggle="tab"
      data-bs-target="#chasisB" type="button" role="tab">
      Chasis B
    </button>
  </li>
</ul>
      ...
      <!-- Pie de modal -->
        <div class="modal-footer bg-light border-top">
            ...
            <button type="button" class="btn bg-gradient-primary" id="btnPlanearViaje">
                <i class="bi bi-flag me-1"></i> Planear
            </button>
