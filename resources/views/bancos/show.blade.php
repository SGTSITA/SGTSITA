    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('estadoSwitch').addEventListener('change', function() {
                let bancoId = this.getAttribute('data-id');
                let estado = this.checked ? 1 : 0;
                let switchElement = this;

                // Mostrar confirmación con SweetAlert2
                Swal.fire({
                    title: estado ? "Activar Banco" : "Desactivar Banco",
                    text: estado ? "¿Estás seguro de activar este banco?" :
                        "¿Estás seguro de desactivar este banco?",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: estado ? "#28a745" : "#d33",
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    Swal.fire({
                                        ...
                                        text: estado ?
                                            "El banco ha sido activado correctamente." :
                                            "El banco ha sido desactivado correctamente.",
                                        icon: "success",
                                        timer: 2000,
