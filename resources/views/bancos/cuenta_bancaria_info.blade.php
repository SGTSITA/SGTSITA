         ...
         <div class="flex items-center gap-4">
          <div class="relative size-[50px] shrink-0">
           ...
           <div class="absolute leading-none ">
            <img src="{{asset('/asset/media/bancos/banamex.jpg')}}" alt="">
           </div>
          </div>
...
<script>
    ...
    dictionary: {
      ...
      LOADING_SUBTITLE: 'Por favor espere un momento',
    },
  };

  Handsontable.languages.registerLanguageDictionary(miTraduccion);
