            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-success text-gradient" id="labelTitle">Agregar Operación
                            Bancaria</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="txtDescripcion"
                                placeholder="Descripción de la operación" aria-label="Descripción del gasto" />
                        </div>
                        <label>Monto</label>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control moneyformat" id="txtMonto" placeholder="$ 0.00"
                                aria-label="$ 0.00" oninput="allowOnlyDecimals(event)" />
                        </div>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="mb-2 text-sm">
                                <span class="text-dark font-weight-bold ms-2">
                                    <select class="form-select subcliente d-inline-block" id="tipoTransaccion"
                        ...
                        <div class="text-center">
                            <button type="button" id="btnAgregar" onclick ="addMovimientoBanco({{ $banco->id }})"
...
>>>>>>> e9adcff3bdda8003082f5903f347e6ea5bd81db0
