        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6 form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input
                                    name="nombreOperadorSub"
                                    id="nombreOperadorSub"
                                    type="text"
                                    class="form-control"
                                />
                            </div>
                        ...
                        <div class="col-6 form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input
                                    name="telefonoOperadorSub"
                                    id="telefonoOperadorSub"
                                    type="text"
                                    class="form-control"
                                    maxlength="10"
                                    pattern="\d{10}"
                        ...
                        <div class="col-6 form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input
                                    name="placasOperadorSub"
                                    id="placasOperadorSub"
                                    type="text"
                                    class="form-control"
                                />
                            </div>
                ...
                @can('planeacion-finalizar')
                    <h6 class="mt-3 mb-3">¿Deseas Finalizar el Viaje?</h6>
