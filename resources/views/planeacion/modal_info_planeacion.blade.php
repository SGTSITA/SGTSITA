    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center">
                <h5 class="modal-title" id="viajeModalLabel">Detalle planeación</h5>
                <p class="text-sm">
                    <span class="badge badge-sm" id="tipoViajeSpan">Viaje Subcontratado</span>
                </p>
            </div>
            <div class="modal-body">
                ...
                <div class="">
                    ...
                    <div>
                        <p class="text-sm mb-0">
                            Nombre Cliente:
                            <b id="nombreCliente"></b>
                        </p>
                        <p class="text-sm mb-0">
                            Sub Cliente:
                            <b id="nombreSubcliente"></b>
                        </p>
                    </div>
                </div>
                <div class="">
                    ...
                    <div>
                        ...
                        <p class="text-sm">
                            Contacto Entrega:
                            <b id="ContactoEntrega"></b>
                        </p>

                        <p class="text-sm">
                            Operador:
                            <b id="nombreOperador"></b>
                        </p>
                ...
                <div class="">
                    ...
                    <div>
                        <p class="text-sm">
                            Camion:
                            <b id="id_equipo_camion"></b>
                        </p>
                        <p class="text-sm">
                            Placas:
                            <b id="placas_camion"></b>
                        </p>
                        <p class="text-sm">
                            Marca:
                            <b id="marca_camion"></b>
                ...
                <div class="">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <tbody>
                                <tr>
                                    <td class="documentos" id="boleta_liberacion">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                    <td class="documentos" id="doc_ccp">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                    <td class="documentos" id="doda">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                    <td class="documentos" id="boleta_vacio">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                    <td class="documentos" id="carta_porte_xml">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                    <td class="documentos" id="carta_porte">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                    <td class="documentos" id="doc_eir">
                                        <i class="fas fa-circle-xmark text-secondary fa-lg"></i>
                                    </td>
                                </tr>
                            </tbody>
