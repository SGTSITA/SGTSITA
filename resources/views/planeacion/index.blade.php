                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="search-container">
                                ...
                                <input type="text" id="txtBuscarContenedor" class="input-apple-style"
                                    placeholder="Buscar...">
                            </div>

                            <div class="">
                                <button onclick="confirmarCambiosPlaneacion()" type="button"
                                    class="btn btn-sm bg-gradient-success d-none" id="btnGuardarBoard">
                                    <i class="fa fa-fw fa-save"></i> Confirmar cambios en Board
                                </button>
                                @cannot('Proveedor Autonomo 11am')
                                    <!--Ocultar cuando  tenga este permiso porq no debe existir este boton, esta en seguimiento  -->
...
@push('custom-javascript')
    ...
    <script type="text/javascript"
        src="{{ asset('DayPilot/js/boardCarpos.js') }}?v={{ filemtime(public_path('DayPilot/js/boardCarpos.js')) }}">
    </script>
