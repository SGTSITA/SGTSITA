            ...
            <div class="card">
                <div class="card-body">
                    <div class="multisteps-form__progress">
                        ...
                        <button class="multisteps-form__progress-btn" type="button" title="Address">Datos del
                            transporte</button>
                        <button class="multisteps-form__progress-btn" type="button" title="Socials">Fechas del
                            viaje</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-footer">
                        <div class="multisteps-form__content">
                            <div class="button-row d-flex mt-4">
                                <button class="btn bg-gradient-info btn-sm ms-auto mb-0 js-btn-next" id="nextOne"
                                    disabled="true" type="button" title="Siguiente"> Siguiente <i
                ...
                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                    ...
                    <div class="multisteps-form__content">
                        ...
                        <div class="button-row d-flex mt-4">
                            ...
                            <button class="btn bg-gradient-info btn-sm ms-auto mb-0 js-btn-next" id="nextTwo"
                                disabled="true" type="button" title="Siguiente"> Siguiente <i
                                    class="fa fa-arrow-right"></i>
                            </button>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group ">
                                                ...
                                                <input class="form-control dateInput" name="txtFechaFinal"
                        ...
                        <div class="row mt-3">
                            <div class="button-row d-flex mt-4 col-12">
                                <button class="btn bg-gradient-info btn-sm mb-0 js-btn-prev" type="button"
                                    title="Anterior">
                                    <i class="fa fa-arrow-left"></i> Anterior </button>
                                <button class="btn bg-gradient-success btn-sm ms-auto mb-0" type="button"
                                    id="btnProgramar" title="Send">Programar viaje</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('custom-javascript')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Evento para validar proveedor antes de guardar
            document.getElementById('btnProgramar').addEventListener('click', function() {
                const tipoViaje = document.querySelector('input[name="option"]:checked')?.value;

                if (tipoViaje === 'proveedor') {
                    const proveedorSeleccionado = document.getElementById('cmbProveedor')?.value || '';
                    if (proveedorSeleccionado.trim() === '') {
                        ...
                        return; // Detiene la ejecución si no hay proveedor
                    }
                }

                // Aquí va tu lógica para guardar la planeación (AJAX o submit)
                console.log('Planeación válida, ejecutar guardado...');
                // guardarPlaneacion();
            });
        });
    </script>
