        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('store.gastos_generales') }}" id="frmCrearGasto"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm bg-gradient-success" id="btnConfirmaPago">
                        Confirmar pago
                    </button>
                </div>
            </form>
