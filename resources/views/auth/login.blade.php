    ...
    <div class="d-flex flex-column flex-root">
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    <div class="w-lg-500px p-10">
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            data-kt-redirect-url="/dashboard" method="POST" action="{{ route('login.custom') }}">
                            @csrf
                            ...
                            <div class="fv-row mb-3 position-relative">
                                <input type="password" placeholder="Password" name="password" id="password"
                                    autocomplete="off" class="form-control bg-transparent pe-10" />

                                <span class="position-absolute top-50 end-0 translate-middle-y me-3 cursor-pointer"
                                    onclick="togglePassword()" style="font-size: 1.5rem;">
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">
                                ¿Aún no tiene cuenta?
                                <a href="/accounts/register" class="link-primary">Registrese</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-1"
                style="background-image: url(/assets/metronic/background-cfdi-stack.jpg)">
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    <a href="/" class="mb-0 mb-lg-8">
                        <img alt="Logo" src="/assets/metronic/logo-blanco-sgt.png" class="h-35px h-lg-40px" />
                    </a>
                    <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-8">
                        Sistema de Gestión de Transporte
                    </h1>
                    <div class="d-none d-lg-block text-white fs-base text-center">
                        Planeación, coordinación y control del movimiento de mercancías de un lugar a otro. Esto
                        incluye la planificación, implementación y control del transporte de productos y servicios.
                        <a href="#" class="opacity-75-hover text-warning fw-bold me-1"></a>
                    </div>

                    <img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-15"
                        src="/assets/metronic/ship.webp" alt="" />
                </div>
            </div>
        </div>
    </div>
