    ...
    <div class="modal-content">
        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              <h6 for="example-text-input" class="form-control-label">Descripción: <span id="labelDescripcionGasto" class="text-muted"></span>
              </h6>
            </div>
            <div class="col-6">
          ...
          <div class="col-12 d-none aplicacion-gastos" id="aplicacion-viaje">
            ...
            <select class="form-control" name="selectViajes" id="selectViajes" multiple> @foreach($viajes as $e) <option value="{{$e->id_contenedor}}"> {{$e->num_contenedor}}</option> @endforeach </select>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm bg-gradient-success" id="btnConfirmacion">
          <i class="fa fa-fw fa-coins"></i> Aplicar gasto </button>
      </div>
    </div>
  </div>
</div>