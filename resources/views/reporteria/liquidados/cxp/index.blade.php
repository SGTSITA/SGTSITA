                    ...
                    <div class="card-body">
                                            ...
                                            <div class="card-body" style="padding-left: 1.5rem; padding-top: 1rem;">
                                                ...
                                                <div class="row align-items-end">
                                                    <div class="col-md-3 mb-2">
                                                        <label for="id_proveedor" class="form-label text-sm mb-1">Buscar proveedor:</label>
                                                    ...
                                                    <div class="col-md-3 mb-2">
                                                        ...
                                                        <select class="form-control unidad" name="id_unidad" id="id_unidad">
                                                    ...
                                                    <div class="col-md-3 mb-2 d-flex gap-2">
                                                        <button class="btn btn-sm mb-0 p-2" type="submit" style="background-color: #F82018; color: #ffffff;">Buscar</button>
                                                        <a href="{{ route('index_liquidados_cxp.reporteria') }}" class="btn btn-sm btn-outline-secondary mb-0 p-2">Limpiar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                        ...
                        <div class="table-responsive">
                            ...
                            <form id="exportForm" action="{{ route('liquidados_cxp.export') }}" method="POST">
                                @csrf
                                @if(Route::currentRouteName() != 'index_liquidados_cxp.reporteria' && isset($proveedor_cxp))
            ...
            $('.exportButton').on('click', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response, status, xhr) {
                        ...
                        var downloadName = 'cxp_' + fileType;
