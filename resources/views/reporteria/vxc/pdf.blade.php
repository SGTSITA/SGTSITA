...
<body>
    ...
    <div class="totales">
        <p><strong>Total generado:</strong> ${{ number_format(floatval($totalGenerado), 2) }}</p>
        <p><strong>Retenido:</strong> ${{ number_format(floatval($retenido), 2) }}</p>
        <p><strong>Pago neto:</strong> ${{ number_format(floatval($pagoNeto), 2) }}</p>
    </div>
</body>
