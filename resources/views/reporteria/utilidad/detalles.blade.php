<div class="modal fade" id="detalles{{ $cotizacion->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value=" ${{ number_format($cotizacion->total, 2, '.', ',') }}" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                @if ($cotizacion->total_proveedor == null)
                                    <input type="text" class="form-control"
                                        value=" ${{ number_format($cotizacion->pago_operador, 2, '.', ',') }}" readonly>
                                @else
                                    <input type="text" class="form-control"
                                        value=" ${{ number_format($cotizacion->total_proveedor, 2, '.', ',') }}"
                                        readonly>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                @endphp
                                <input type="text" class="form-control" id="pago_operador" name="pago_operador"
                                    value=" ${{ number_format($utilidad, 2, '.', ',') }}" readonly>
                            </div>
                        </div>
                    </div>
