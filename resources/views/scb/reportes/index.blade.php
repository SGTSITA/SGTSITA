...
@section('content')
    ...
    <div class="scb-card">
        ...
        <div class="scb-card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <button type="button" class="btn scb-btn-primary w-100" id="btnConsultarReporte">
            ...
            <div class="d-flex justify-content-end gap-2 mt-3">
                <button type="button" class="btn btn-outline-danger" id="btnReportePdf">
                    <i class="fas fa-file-pdf me-1"></i>
                    PDF
                </button>

                <button type="button" class="btn btn-outline-success" id="btnReporteExcel">
    ...
    <div class="row g-3 my-4 d-none" id="resumenReporte">
        ...
        <div class="col-md-3">
            <div class="reporte-card reporte-card-danger">
                <small>Cargos</small>
        ...
        <div class="col-md-3">
            <div class="reporte-card reporte-card-success">
                <small>Abonos</small>
