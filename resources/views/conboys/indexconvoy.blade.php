                    ...
                    <div id="resultadoConvoy" style="display: none">
                        ...
                        <div class="modal-footer">
                            <button
                                ...
                                onclick="limpiarFormularioConvoy()"
                            >
                                Cerrar
                            </button>
...
@push('custom-javascript')
    ...
    <script src="{{ asset('js/sgt/coordenadas/encontrarconvoys.js') }}?v={{ filemtime(public_path('js/sgt/coordenadas/encontrarconvoys.js')) }}"></script>
@endpush
