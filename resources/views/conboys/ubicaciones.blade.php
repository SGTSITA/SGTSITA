            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <span id="distancia_km">-</span>
                        km
                    </p>
                    <p>
                        <strong>Ubicación esperada:</strong>
                        <span id="lat1"></span>
                        ,
                        <span id="lng1"></span>
                    </p>
...
@push('custom-javascript')
    ...
    <script src="{{ asset('js/sgt/coordenadas/ubicaciones-list.js') }}?v={{ filemtime(public_path('js/sgt/coordenadas/ubicaciones-list.js')) }}"></script>
@endpush
