...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="/">
  ...
  <meta content="SGT - Sistema de Gestión de Transporte " name="twitter:title"/>

  <meta content="{{asset('asset/media/app/og-image.png')}}" name="twitter:image"/>

  <meta content="es_MX" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="SGT - Sistema de Gestión de Transporte " property="og:title"/>
  <meta content="" property="og:description"/>
  <meta content="{{asset('asset/media/app/og-image.png')}}" property="og:image"/>
  <link href="{{asset('asset/media/app/apple-touch-icon.png')}}" rel="apple-touch-icon" sizes="180x180"/>
  <link href="{{asset('asset/media/app/favicon-32x32.png')}}" rel="icon" sizes="32x32" type="image/png"/>
  <link href="{{asset('asset/media/app/favicon-16x16.png')}}" rel="icon" sizes="16x16" type="image/png"/>
  <link href="{{asset('asset/media/app/favicon.ico')}}" rel="shortcut icon"/>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet"/>
  <link href="{{asset('asset/vendors/apexcharts/apexcharts.css')}}" rel="stylesheet"/>
  <link href="{{asset('asset/vendors/keenicons/styles.bundle.css')}}" rel="stylesheet"/>
  ...
  <!-- Vite asset -->
      <style>
          .upgrade-bg {
            background-image: url('/asset/media/images/2600x1200/bg-5.png');
          }
          .dark .upgrade-bg {
            background-image: url('/asset/media/images/2600x1200/bg-5-dark.png');
          }
       </style>
 </head>
 <body class="antialiased flex h-full text-base text-foreground bg-background demo1 kt-sidebar-fixed kt-header-fixed">
          ...
          <div class="kt-menu-item">
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            ...
            <div class="flex justify-end shrink-0">
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-14.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-12.png"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-9.png"/>
              </div>
             </div>
            </div>
           </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-6.png"/>
            </div>
            <div class="flex">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-8.png"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-18.png"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-17.png"/>
            </div>
           </div>
          </div>
         </div>
         ...
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-20.png"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="/asset/media/avatars/300-21.png"/>
            </div>
           </div>
          </div>
         </div>
  ...
  <!-- End of Page -->
  <!-- Scripts -->
  <script src="{{asset('asset/js/core.bundle.js')}}">
  </script>
  <script src="{{asset('asset/vendors/ktui/ktui.min.js')}}">
  </script>
  <script src="{{asset('asset/vendors/apexcharts/apexcharts.min.js')}}">
  </script>
  <script src="{{asset('asset/js/widgets/general.js')}}">
  </script>
  <script src="{{asset('asset/js/layouts/demo1.js')}}">
  </script>
  <!-- End of Scripts -->
 </body>
</html>
