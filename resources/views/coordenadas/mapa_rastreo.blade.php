...
<html>
    ...
    <body>
        ...
        <div
            ...
            id="modalInfoViaje"
            tabindex="-1"
            aria-labelledby="modalInfoViajeLabel"
            aria-hidden="true"
        >
                        ...
                        contenedores.forEach((cod) => {
                            ...
                            if (infoc) {
                                ...
                                if (tipoSpans.toLowerCase().includes('convoy')) {
                                    ...
                                    if (infoc2) {
                                        let conponerStrin =
                                            cod + '|' + infoc2.imei + '|' + infoc2.id_contenedor + '|' + infoc2.tipoGps;
                                        ItemsSelects.push(conponerStrin);
                                    } else {
        ...
        <script
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAtAO2AZBgzC7QaBxnMnPoa-DAq8vaEvUc&libraries=geometry&callback=initMap"
            async
            defer
        ></script>
    </body>
