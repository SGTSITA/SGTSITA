...
@section('content')
    <style>
        ...
        input:checked+.slider:before {
            ...
            /* Mueve el círculo completamente a la derecha */
        }

        input:checked+.slider #ubicacion-texto {
            transform: translateX(80px);
            /* Mueve el texto hacia la derecha cuando activado */
        }

        input:not(:checked)+.slider #ubicacion-texto {
            transform: translateX(-80px);
            /* Mueve el texto a la izquierda cuando desactivado */
        }

        .btn-close {
            filter: invert(1);
            /* Invierte el color (útil en fondos blancos) */
        }
    </style>
                    ...
                    <div class="modal-body">
                        <form id="formFiltros">
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <div id="sugerencias"
                                    style="border: 1px solid #ccc; max-height: 150px; overflow-y: auto; display: none; position: absolute; background: white; z-index: 1050; width: 100%;">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="ubicacion-toggle"
                                        checked aria-checked="true">
                                    <label class="form-check-label" id="ubicacion-texto" for="ubicacion-toggle">Última
                                        ubicación</label>
                                </div>
                            </div>
