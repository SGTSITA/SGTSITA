                                            ...
                                            <div class="col-12 mb-4">
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        type="radio"
                                                        name="validaroperador"
                                                        id="validaroperador_no"
                                                        value="No"
                                                    />
                                                ...
                                                <div class="col-12 mb-4">
                                                    ...
                                                    >
                                                        <input
                                                            class="form-check-input"
                                                            type="radio"
                                                            name="registro_puerto"
                                                            id="registro_puerto_no"
                                                            value="No"
                                                            checked
                                                        />
                                                    ...
                                                    <input
                                                        type="hidden"
                                                        id="latitud_longitud_registro_puerto"
                                            ...
                                            @if ($coordenadas->registro_puerto != null)
                                                @if ($coordenadas->dentro_puerto == null)
                                                    <div class="col-12 mb-4">
                                                        ...
                                                        <input
                                                            type="hidden"
                                                            id="latitud_longitud_dentro_puerto"
                                                ...
                                                @else
                                                    <div class="col-12 mb-4 coordenadas_contestado">
                                                        ...
                                                        @auth
                                                            <br />
                                                            <button
                                                                onclick="abrirEnMapsdentro_puerto()"
                                                ...
                                                @if ($coordenadas->dentro_puerto != null)
                                                    @if ($coordenadas->descarga_vacio == null)
                                                        <div class="col-12 mb-4">
                                                            ...
                                                            <input
                                                                type="hidden"
                                                                id="latitud_longitud_descarga_vacio"
                                                        ...
                                                        @else
                                                            <div class="col-12 mb-4 coordenadas_contestado">
                                                                ...
                                                                @auth
                                                                    <br />
                                                                    <button
                                                                        onclick="abrirEnMapscargado_contenedor()"
                                                                        class="btn btn-primary btn-sm"
                                                                    >
                                                                        <img
                                                                            src="{{ asset('img/icon/gps.webp') }}"
                                                            ...
                                                            @else
                                                                <div class="col-12 mb-4 coordenadas_contestado">
                                                                    ...
                                                                    @auth
                                                                        <br />
                                                                        <button
                                                                            onclick="abrirEnMapsfila_fiscal()"
                                                                            class="btn btn-primary btn-sm"
                                                                        >
                                                                            <img
                                                                                src="{{ asset('img/icon/gps.webp') }}"
                                            ...
                                            @if ($coordenadas->validaroperador == 'Si')
                                                @if ($coordenadas->Cotizacion->estatus == 'Aprobada')
                                                    <button type="submit" class="btn btn-success w-100 my-4 mb-2">
                                                        <img
                                                            src="{{ asset('img/icon/disquete-imageonline.co-5785320.webp') }}"
                                                            alt=""
                                                            width="20px"
                                                        />
                                                        - Actualizar
