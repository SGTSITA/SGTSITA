...
<head>
    ...
    <link rel="icon" type="image/png"
        href="https://paradisus.mx/favicon/639893ee3d1ff63891f2fbd91b277248048_670190130923536_7018383830884135385_n__1_-removebg-preview.png" />
    <title>SGT</title>
    <!--     Fonts and icons     -->
    ...
    <p>
        ...
        @if ($respuesta)
            <span class="text-success">Respondida ({{ $respuesta }})</span>
        @else
            <span class="text-danger">Pendiente</span>
        @endif
    </p>
    @if ($preguntasContestadas > 0)
        <button onclick="mostrarRuta()" class="btn btn-primary mt-3">
            <img src="{{ asset('img/icon/gps.webp') }}" alt="" width="15px" />
            Ver recorrido {{ $preguntasContestadas }}
        </button>
    @endif

    <!--  else {
                  [$lat, $lng] = explode(',', $coordenadas->$campo);
                  $lat = floatval($lat);
                  $lng = floatval($lng);

                  if ($respuesta && isset($lat) && isset($lng)) {
                      $coordenadasRuta[] = [ 'lat' => $lat, 'lng' => $lng  ];
...
<body class="">
                    ...
                    <div class="col-12 col-md-10 col-lg-8">
                        <div class="card border-0 mb-0">
                            <div class="card-header bg-transparent">
                                ...
                                <h4 class="text-dark text-center mt-2 mb-3">Sistema de Gestion de Transporte</h4>

                                @if ($coordenadas->Cotizacion->DocCotizacion->num_contenedor == null)
                                    Falta asignar Contenedor
                                @else
                                    <p>
                                        <strong>Num de Contenedor :</strong>
                                        #{{ $coordenadas->Cotizacion->DocCotizacion->num_contenedor }}
                                    </p>
                                @endif
                                ...
                                @if ($coordenadas->Asignaciones->id_operador == null)
                                    <p>Subcontratado</p>
                                    <p>
                                        <strong>Telefono operador :</strong>
                                        {{ $coordenadas->Asignaciones->telefonoOperadorSub }}
                                    </p>
                                    <p>
                                        <strong>Num. placas :</strong>
                                        {{ $coordenadas->Asignaciones->placasOperadorSub }}
                                    </p>
                                    <p>
                                        <strong>Nombre del operador:</strong>
                                        {{ $coordenadas->Asignaciones->nombreOperadorSub }}
                                    </p>
                                @else
                                    <p>
                                        <strong>Telefono operador :</strong>
                                        {{ $coordenadas->Asignaciones->Operador->telefono }}
                                    </p>
                                    <p>
                                        <strong>Num. placas :</strong>
                                        {{ $coordenadas->Asignaciones->Camion->placas }}
                                    </p>
                                    <p>
                                        <strong>Nombre del operador:</strong>
                                        {{ $coordenadas->Asignaciones->Operador->nombre }}
                                    </p>
                                @endif
                            </div>
                            <div class="card-body px-lg-5 pt-0">
                                    ...
                                    @if ($coordenadas->validaroperador != 'Si')
                                        <div class="col-12 mb-4">
                                            ...
                                            <div class="form-check" style="display: inline-block; margin-right: 3rem">
                                                <input class="form-check-input" type="radio" name="validaroperador"
                                                    id="validaroperador_no" value="No" />
                                                <label class="form-check-label" for="validaroperador_no">No</label>
                                            </div>

                                            <div class="form-check" style="display: inline-block">
                                                <input class="form-check-input" type="radio" name="validaroperador"
                                                    id="validaroperador_si" value="Si" />
                                                <label class="form-check-label" for="validaroperador_si">Si</label>
                                            </div>
                                        </div>
                                    @else
                                        <div class="col-12 mb-4 coordenadas_contestado">
                                            ...
                                            @endif
                                            <div class="form-check" style="display: inline-block">
                                                <input class="form-check-input" type="radio" id="validaroperador_si"
                                                    checked disabled />
                                        ...
                                        @if ($coordenadas->registro_puerto == null)
                                            <div class="col-12 mb-4">
                                                ...
                                                <div class="form-check"
                                                    style="display: inline-block; margin-right: 3rem; display: none">
                                                    <input class="form-check-input" type="radio"
                                                        name="registro_puerto" id="registro_puerto_no" value="No"
                                                        checked />
                                                ...
                                                <div class="form-check" style="display: inline-block">
                                                    <input class="form-check-input" type="radio"
                                                        name="registro_puerto" id="registro_puerto_si" value="Si" />
                                                    <label class="form-check-label" for="registro_puerto_si">
                                                        Si
                                                    </label>
                                                </div>

                                                <input type="hidden" id="latitud_longitud_registro_puerto"
                                                    name="latitud_longitud_registro_puerto" />
                                            </div>
                                        @else
                                            <div class="col-12 mb-4 coordenadas_contestado">
                                                <h5 class="text-left">1) Registro en Puerto ?</h5>
                                                ...
                                                <div class="form-check" style="display: inline-block">
                                                    <input class="form-check-input" type="radio"
                                                        id="registro_puerto_si" checked disabled />
                                                    <label class="form-check-label" for="registro_puerto_si">
                                                        Si
                                                    </label>
                                                </div>

                                                <input type="hidden" name="latitud_longitud_registro_puerto"
                                                    value="{{ $coordenadas->registro_puerto }}" />

                                                @auth
                                                    <br />
                                                    <button onclick="abrirEnMaps()" class="btn btn-primary btn-sm">
                                                    ...
                                                    <script>
                                                        function abrirEnMaps() {
                                                            ...
                                                            var coordenadasFormato = coordenadas
                                                                .replace(',', '+')
                                                                .replace(' ', '+');
                                                ...
                                                <div class="col-12 mb-4">
                                                    ...
                                                    <div class="form-check"
                                                        style="
                                                            ...
                                                            ">
                                                        <input class="form-check-input" type="radio"
                                                            name="dentro_puerto" id="dentro_puerto_no" value="No"
                                                            checked />
                                                    ...
                                                    <div class="form-check" style="display: inline-block">
                                                        <input class="form-check-input" type="radio"
                                                            name="dentro_puerto" id="dentro_puerto_si"
                                                            value="Si" />
                                                    ...
                                                    <input type="hidden" id="latitud_longitud_dentro_puerto"
                                                        name="latitud_longitud_dentro_puerto" />
                                                </div>
                                            @else
                                                <div class="col-12 mb-4 coordenadas_contestado">
                                                    <h5 class="text-left">2) Dentro de Puerto ?</h5>
                                                    ...
                                                    <div class="form-check" style="display: inline-block">
                                                        <input class="form-check-input" type="radio"
                                                            id="dentro_puerto_si" checked disabled />
                                                        <label class="form-check-label" for="dentro_puerto_si">
                                                            Si
                                                        </label>
                                                    </div>

                                                    <input type="hidden" name="latitud_longitud_dentro_puerto"
                                                        value="{{ $coordenadas->dentro_puerto }}" />

                                                    @auth
                                                        <br />
                                                        <button onclick="abrirEnMapsdentro_puerto()"
                                                    ...
                                                    <div class="col-12 mb-4">
                                                        ...
                                                        <div class="form-check"
                                                            style="
                                                                ...
                                                                ">
                                                            <input class="form-check-input" type="radio"
                                                                name="descarga_vacio" id="descarga_vacio_no"
                                                                value="No" checked />
                                                        ...
                                                        <div class="form-check" style="display: inline-block">
                                                            <input class="form-check-input" type="radio"
                                                                name="descarga_vacio" id="descarga_vacio_si"
                                                                value="Si" />
                                                        ...
                                                        <input type="hidden" id="latitud_longitud_descarga_vacio"
                                                            name="latitud_longitud_descarga_vacio" />
                                                    </div>
                                                @else
                                                    <div class="col-12 mb-4 coordenadas_contestado">
                                                        <h5 class="text-left">3) Descarga Vacío?</h5>
                                                        ...
                                                        <div class="form-check" style="display: inline-block">
                                                            <input class="form-check-input" type="radio"
                                                                id="descarga_vacio_si" checked disabled />
                                                            <label class="form-check-label" for="descarga_vacio_si">
                                                                Si
                                                            </label>
                                                        </div>

                                                        <input type="hidden" name="latitud_longitud_descarga_vacio"
                                                            value="{{ $coordenadas->descarga_vacio }}" />
                                                        @auth
                                                            <br />
                                                            <button onclick="abrirEnMapsdescarga()"
                                                                class="btn btn-primary btn-sm">
                                                                <img src="{{ asset('img/icon/gps.webp') }}"
                                                                    alt="" width="15px" />
                                                                Ver en Maps
                                                            </button>
                                                        ...
                                                        <div class="col-12 mb-4">
                                                            ...
                                                            <div class="form-check"
                                                                style="
                                                                    ...
                                                                    ">
                                                                <input class="form-check-input" type="radio"
                                                                    name="cargado_contenedor"
                                                                    id="cargado_contenedor_no" value="No"
                                                                    checked />
                                                                <label class="form-check-label"
                                                                    for="cargado_contenedor_no">
                                                                    No
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="form-check" style="display: inline-block">
                                                                <input class="form-check-input" type="radio"
                                                                    name="cargado_contenedor"
                                                                    id="cargado_contenedor_si" value="Si" />
                                                                <label class="form-check-label"
                                                                    for="cargado_contenedor_si">
                                                                    Si
                                                                </label>
                                                            </div>

                                                            <input type="hidden"
                                                                id="latitud_longitud_cargado_contenedor"
                                                                name="latitud_longitud_cargado_contenedor" />
                                                        </div>
                                                    @else
                                                        <div class="col-12 mb-4 coordenadas_contestado">
                                                            <h5 class="text-left">4)Cargado Contenedor ?</h5>
                                                            ...
                                                            <div class="form-check" style="display: inline-block">
                                                                <input class="form-check-input" type="radio"
                                                                    id="cargado_contenedor_si" disabled checked />
                                                                <label class="form-check-label"
                                                                    for="cargado_contenedor_si">
                                                                    Si
                                                                </label>
                                                            ...
                                                            <input type="hidden"
                                                                name="latitud_longitud_cargado_contenedor"
                                                                value="{{ $coordenadas->cargado_contenedor }}" />
                                                            @auth
                                                                <br />
                                                                <button onclick="abrirEnMapscargado_contenedor()"
                                                                    class="btn btn-primary btn-sm">
                                                                    <img src="{{ asset('img/icon/gps.webp') }}"
                                                                        alt="" width="15px" />
                                                                    Ver en Maps
                                                            ...
                                                            <div class="col-12 mb-4">
                                                                ...
                                                                <div class="form-check"
                                                                    style="
                                                                        ...
                                                                        ">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="fila_fiscal" id="fila_fiscal_no"
                                                                        value="No" checked />
                                                                    <label class="form-check-label"
                                                                        for="fila_fiscal_no">
                                                                        No
                                                                ...
                                                                <div class="form-check" style="display: inline-block">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="fila_fiscal" id="fila_fiscal_si"
                                                                        value="Si" />
                                                                    <label class="form-check-label"
                                                                        for="fila_fiscal_si">
                                                                        Si
                                                                ...
                                                                <input type="hidden"
                                                                    id="latitud_longitud_fila_fiscal"
                                                                    name="latitud_longitud_fila_fiscal" />
                                                            </div>
                                                        @else
                                                            <div class="col-12 mb-4 coordenadas_contestado">
                                                                <h5 class="text-left">5) En Fila Fiscal ?</h5>
                                                                ...
                                                                <div class="form-check" style="display: inline-block">
                                                                    <input class="form-check-input" type="radio"
                                                                        id="fila_fiscal_si" disabled checked />
                                                                    <label class="form-check-label"
                                                                        for="fila_fiscal_si">
                                                                        Si
                                                                    </label>
                                                                ...
                                                                <input type="hidden"
                                                                    name="latitud_longitud_fila_fiscal"
                                                                    value="{{ $coordenadas->fila_fiscal }}" />
                                                                @auth
                                                                    <br />
                                                                    <button onclick="abrirEnMapsfila_fiscal()"
                                                                        class="btn btn-primary btn-sm">
                                                                        <img src="{{ asset('img/icon/gps.webp') }}"
                                                                            alt="" width="15px" />
                                                                        Ver en Maps
                                                                ...
                                                                <div class="col-12 mb-4">
                                                                    ...
                                                                    <div class="form-floating">
                                                                        <select class="form-select"
                                                                            name="modulado_tipo" id="modulado_tipo">
                                                                            <option value="">Selecionar</option>
                                                                            <option value="5.1) Verde">
                                                                                5.1) Verde
                                                                            </option>
                                                                            <option value="5.2) Amarillo">
                                                                                5.2) Amarillo
                                                                            </option>
                                                                            <option value="5.3) Rojo">
                                                                                5.3) Rojo
                                                                            </option>
                                                                            <option value="5.4) OVT">
                                                                                5.4) OVT
                                                                            </option>
                                                                        </select>
                                                                    ...
                                                                    <input type="hidden"
                                                                        id="latitud_longitud_modulado_tipo"
                                                                        name="latitud_longitud_modulado_tipo" />
                                                                </div>
                                                            @else
                                                                <div class="col-12 mb-4 coordenadas_contestado">
                                                                    <h5 class="text-left">6) Modulado</h5>
                                                                    ...
                                                                    <div class="form-floating">
                                                                        <select class="form-select"
                                                                            ...
                                                                            redonly>
                                                                            <option
                                                                                value="{{ $coordenadas->modulado_tipo }}">
                                                                    ...
                                                                    <div class="col-12 mb-4">
                                                                        ...
                                                                        <div class="form-check"
                                                                            ...
                                                                            <input class="form-check-input"
                                                                                type="radio" name="en_destino"
                                                                                id="en_destino_no" value="No"
                                                                                checked />
                                                                            <label class="form-check-label"
                                                                                for="en_destino_no">
                                                                                No
                                                                        ...
                                                                        <input type="hidden"
                                                                            id="latitud_longitud_en_destino"
                                                                            name="latitud_longitud_en_destino" />
                                                                    </div>
                                                                @else
                                                                    <div class="col-12 mb-4 coordenadas_contestado">
                                                                        <h5 class="text-left">7) En Destino</h5>
                                                                        ...
                                                                        <input type="hidden"
                                                                            name="latitud_longitud_en_destino"
                                                                            value="{{ $coordenadas->en_destino }}" />
                                                                        @auth
                                                                            <br />
                                                                            <button onclick="abrirEnMapsen_destino()"
                                                                                class="btn btn-primary btn-sm">
                                                                                <img src="{{ asset('img/icon/gps.webp') }}"
                                                                                    alt="" width="15px" />
                                                                                Ver en Maps
                                                                    ...
                                                                    @if ($coordenadas->inicio_descarga == null)
                                                                        <div class="col-12 mb-4">
                                                                            ...
                                                                            <div class="form-check"
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="radio"
                                                                                    name="inicio_descarga"
                                                                                    id="inicio_descarga_no"
                                                                                    value="No" checked />
                                                                                <label class="form-check-label"
                                                                                    for="inicio_descarga_no">
                                                                                    No
                                                                                </label>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-check"
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="radio"
                                                                                    name="inicio_descarga"
                                                                                    id="inicio_descarga_si"
                                                                                    value="Si" />
                                                                                <label class="form-check-label"
                                                                                    for="inicio_descarga_si">
                                                                                    Si
                                                                                </label>
                                                                            </div>

                                                                            <input type="hidden"
                                                                                id="latitud_longitud_inicio_descarga"
                                                                                name="latitud_longitud_inicio_descarga" />
                                                                        </div>
                                                                    @else
                                                                        <div
                                                                            class="col-12 mb-4 coordenadas_contestado">
                                                                            <h5 class="text-left">
                                                                                8) Inicio Descarga
                                                                            </h5>
                                                                            ...
                                                                            <input type="hidden"
                                                                                name="latitud_longitud_inicio_descarga"
                                                                                value="{{ $coordenadas->inicio_descarga }}" />
                                                                            @auth
                                                                                <br />
                                                                                <button
                                                                                    onclick="
                                                                                            abrirEnMapsinicio_descarga()
                                                                                        "
                                                                                    class="btn btn-primary btn-sm">
                                                                                    <img src="{{ asset('img/icon/gps.webp') }}"
                                                                                        alt="" width="15px" />
                                                                    ...
                                                                    @if ($coordenadas->inicio_descarga != null)
                                                                        @if ($coordenadas->fin_descarga == null)
                                                                            <div class="col-12 mb-4">
                                                                                ...
                                                                                <input type="hidden"
                                                                                    id="latitud_longitud_fin_descarga"
                                                                                    name="latitud_longitud_fin_descarga" />
                                                                            </div>
                                                                        @else
                                                                            <div
                                                                                class="col-12 mb-4 coordenadas_contestado">
                                                                                ...
                                                                                <div class="form-check"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        type="radio"
                                                                                        id="fin_descarga_si"
                                                                                        value="{{ $coordenadas->fin_descarga }}"
                                                                                        disabled checked />
                                                                                    <label class="form-check-label"
                                                                                        for="fin_descarga_si">
                                                                                        Si
                                                                            ...
                                                                            @if ($coordenadas->recepcion_doc_firmados == null)
                                                                                <div class="col-12 mb-4">
                                                                                    ...
                                                                                    <div class="form-check"
                                                                                        ...
                                                                                        <input class="form-check-input"
                                                                                            type="radio"
                                                                                            name="recepcion_doc_firmados"
                                                                                            id="recepcion_doc_firmados_no"
                                                                                            value="No" checked />
                                                                                        <label class="form-check-label"
                                                                                            for="recepcion_doc_firmados_no">
                                                                                            No
                                                                                        </label>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="form-check"
                                                                                        ...
                                                                                        <input class="form-check-input"
                                                                                            type="radio"
                                                                                            name="recepcion_doc_firmados"
                                                                                            id="recepcion_doc_firmados_si"
                                                                                            value="Si" />
                                                                                        <label class="form-check-label"
                                                                                            for="recepcion_doc_firmados_si">
                                                                                            Si
                                                                                        </label>
                                                                                    </div>

                                                                                    <input type="hidden"
                                                                                        id="latitud_longitud_recepcion_doc_firmados"
                                                                                        name="latitud_longitud_recepcion_doc_firmados" />
                                                                                </div>
                                                                            @else
                                                                                <div
                                                                                    class="col-12 mb-4 coordenadas_contestado">
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        name="latitud_longitud_recepcion_doc_firmados"
                                                                                        value="{{ $coordenadas->recepcion_doc_firmados }}" />
                                                                                    @auth
                                                                                        <br />
                                                                                        <button
                                                                                            onclick="
                                                                                                    abrirEnMapsrecepcion_doc_firmados()
                                                                                                "
                                                                                            class="btn btn-primary btn-sm">
                                                                                            <img src="{{ asset('img/icon/gps.webp') }}"
                                                                                                alt=""
                                        ...
                                        @if ($coordenadas->validaroperador == 'Si')
                                            @if ($coordenadas->Cotizacion->estatus == 'Aprobada')
                                                <button type="submit" class="btn btn-success w-100 my-4 mb-2">
                                                    <img src="{{ asset('img/icon/disquete-imageonline.co-5785320.webp') }}"
                                                        alt="" width="20px" />
                                                    - Actualizar
                                                </button>
                                            @endif
                                ...
                                <div id="infoEstatica" class="mb-4 p-4 text-dark"
                                    ...
                                    <input type="hidden" id="id_asignacion"
                                        value="{{ $coordenadas->id_asignacion }}" />
                                    <input type="hidden" id="id_coordenada"
                                        value="{{ $coordenadas->id_coordenadas }}" />
                                    <p>
                                        📋
                                        <strong>Subcontratado:</strong>
                                        {{ $coordenadas->nombre_empresa . ' - ' . $coordenadas->tipo_contrato }}
                                    </p>
                                    <p>
                                        <strong>Teléfono operador:</strong>
                                        {{ $coordenadas->telefono }}
                                    </p>
                                    <p>
                                        <strong>No contenedor:</strong>
                                        {{ $coordenadas->num_contenedor }}
                                    </p>
                                    <p>
                                        <strong>Num. placas:</strong>
                                        {{ $coordenadas->placas }}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var latitudLongitudInputCargadoContenedor = document.getElementById(
                'latitud_longitud_cargado_contenedor',
            );
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ config('services.googleMapsApi.apikey') }}&callback=iniciarMap">
    </script>
</body>
