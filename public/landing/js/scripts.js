(function ($) {
    ...
    swiperslider.each(function () {
        ...
        if (val_nav === true) {
            if (!nav_arrow) {
                ...
                carouselElement
                    .find('.swiper-buttons')
                    .append('<div class="swiper-button-next swiper-button-next-' + x + '"></div>');
                carouselElement
                    .find('.swiper-buttons')
                    .append('<div class="swiper-button-prev swiper-button-prev-' + x + '"></div>');
            } else {
    ...
    /*-------------------------------------
		Active Hover
	-------------------------------------*/
    $('.active-onhover .pbmit-miconheading-style-3:nth-child(2),.pbmit-miconheading-style-37:first-child').addClass(
    ...
    $('.active-onhover .pbmit-miconheading-style-3,.pbmit-miconheading-style-37')
        .mouseover(function () {
            ...
            $('.pbmit-miconheading-style-3,.pbmit-miconheading-style-37', main_row).removeClass(
                'pbmit-mihbox-hover-active',
            );
        ...
        .mouseout(function () {
            ...
            $('.pbmit-miconheading-style-3:nth-child(2),.pbmit-miconheading-style-37:first-child', main_row).addClass(
                'pbmit-mihbox-hover-active',
            );
        });
