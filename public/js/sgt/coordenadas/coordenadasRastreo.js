        ...
        .then((data) => {
          ...
          `;
                                ...
                                newMarker.addListener("click", () => {
                                    ...
                                    if (!info) {
                                        if (
                                            t.toLowerCase().includes("convoy")
                                        ) {
                                            info =
                                                contenedoresDisponiblesAll.find(
                                                    (d) =>
                                                        d.contenedor ===
                                                        contenedorRes,
                                                );
                                            ...
                                            info = contenedoresDisponibles.find(
                                                (d) => {
                                            ...
                                            if (!info) {
                                                alert(
                                                    "Información del viaje no encontrada.",
                                                );
                                                return;
                                            }
                                        }
                ...
                `;
                                    ...
                                    let infoCMaps = [];
                                    if (t === "Convoy") {
                                        let contenedoresConvoy =
                                            detalleConvoys.filter(
                                                (d) =>
                                                    d.conboy_id ===
                                                    parseInt(id),
                                            );
                                        ...
                                        () => {
                                            ...
                                            btn.addEventListener(
                                                ...
                                                () => {
                                                    ...
                                                    let latLlegada = parseFloat(
                                                        info.latitud,
                                                    );
                                                    let lngLlegada = parseFloat(
                                                        info.longitud,
                                                    );
                        ...
                        if (key.startsWith(KEYITEM + "|")) {
                            if (estado) {
                                if (
                                    ...
                                    console.log(
                                        "Marcador principal empresa no encontrado:",
                                        key,
                                    );
                                }
                            } else {
          ...
          Object.keys(markers).forEach(key => {
           ...
           Object.keys(markers).forEach(key => {
                ...
                console.warn(
                    "La respuesta no es un array de ubicaciones:",
                    data,
                );
            }
        })
