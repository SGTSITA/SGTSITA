...
abrirMapaEnNuevaPestana(latitud,longitud,latitud_seguimiento,longitud_seguimiento,data.contenedor);
        ...
        // document.getElementById('lat1').innerText = latitud;
        // document.getElementById('lng1').innerText = longitud;
        // document.getElementById('lat2').innerText = latitud_seguimiento;
        // document.getElementById('lng2').innerText = longitud_seguimiento;

  //const distancia = calcularDistanciaKm(latitud, longitud, latitud_seguimiento, longitud_seguimiento);
    // document.getElementById('distancia_km').innerText = distancia;
    
    
    // document.getElementById("tituloCompara").innerText= "Comparativa en ubicaciones de contenedor no: "  + data.contenedor
        
        // const modal = new bootstrap.Modal(document.getElementById('modalCompararUbicaciones'));

        
        // modal.show();
        //     if (mapaComparacion !== null) {
        //         mapaComparacion.remove(); // destruye el mapa anterior
        //         mapaComparacion = null;
        //     }

            //      setTimeout(() => {
            //     mapaComparacion = L.map('mapaComparacion').setView([latitud, longitud], 13);

            //     L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            //         attribution: '&copy; OpenStreetMap contributors'
            //     }).addTo(mapaComparacion);

            //     L.marker([latitud, longitud]).addTo(mapaComparacion).bindPopup("Ubicación esperada").openPopup();
            //     L.marker([latitud_seguimiento, longitud_seguimiento]).addTo(mapaComparacion).bindPopup("Ubicación GPS final");

                
            //     L.polyline([[latitud, longitud], [latitud_seguimiento, longitud_seguimiento]], { color: 'red' }).addTo(mapaComparacion);
            // }, 500);
    };
