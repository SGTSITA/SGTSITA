        ...
        fileUploaderInstance.setOption("upload", {
            ...
            onSuccess: function (result, item) {
                ...
                if (data.isSuccess && data.files && data.files[0]) {
                    ...
                    item.data = item.data || {};
                    item.data.optionsl = fileSettings.opcion;
                    item.html
            ...
            onRemove: function (item) {
                $.post("/viajes/documentos/remove", {
                    _token: _token,
                    numContenedor: numContenedor,
                    urlRepo: item.data?.optionsl,
                    file: item.name,
                });
            },
...
async function initFileUploader() {
    const elementos = [
        ...
        {
            opcion: "BoletaPatio",
            titulo: "Boleta de Patio",
            agGrid: "Boleta-de-patio",
            mandatory: true,
        },
    ];
