...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const columnDefs = [
        ...
        { headerName: "Costo del viaje", field: "precio_viaje", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('precio_viaje') },
        { headerName: "Burreo", field: "burreo", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('burreo') },
        { headerName: "Maniobra", field: "maniobra", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('maniobra') },
        { headerName: "Estadía", field: "estadia", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('estadia') },
        { headerName: "Otros", field: "otro", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('otro') },
        { headerName: 'Peso Contenedor', field: "peso_contenedor", floatingFilter: true, width: 100, cellClassRules: cellHighlightRules('peso_contenedor') },
        { headerName: "Sobrepeso", field: "sobrepeso", floatingFilter: true, width: 100, cellClassRules: cellHighlightRules('sobrepeso') },
        { headerName: "Precio sobrepeso", field: "precio_sobrepeso", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('precio_sobrepeso') },
        { headerName: "Base 1", field: "base1", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('base1') },
        { headerName: "Base 2", field: "base2", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('base2') },
        { headerName: "IVA", field: "iva", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('iva') },
        { headerName: "Retención", field: "retencion", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('retencion') },
        { headerName: "Total", field: "total", floatingFilter: true, valueFormatter: money, width: 100, cellClassRules: cellHighlightRules('total') },
        {
            headerName: "Acciones",
            field: "acciones",
            minWidth: 50,
    ...
    fetch(`/costos/mep/pendientes/${idPendiente}/comparacion`)
        ...
        .then(data => {
            ...
            const moneyFields = new Set([
                ...
                "iva", "retencion", "base1", "base2", "precio_sobrepeso", "total"
            ]);
            ...
            tbody.innerHTML = campos.map(campo => {
...
document.getElementById('btnRechazarCambio').addEventListener('click', function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            const camposSeleccionados = Array.from(document.querySelectorAll('input[name="campo_observado"]:checked'))
