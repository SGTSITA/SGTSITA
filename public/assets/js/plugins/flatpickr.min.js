    ...
    function y(g, h) {
                ...
                (function (e) {
                    ...
                    if (void 0 !== a.value && 2 === a.value.length) {
                        ...
                        (u < i
                            ...
                            : u > l &&
                              ((u = a === D.hourElement ? u - l - r(!D.amPM) : i), g && Y(void 0, 1, D.hourElement)),
                            D.amPM &&
                                f &&
        ...
        function K() {
            ...
            (i.setAttribute('aria-label', D.l10n.yearAriaLabel),
                ...
                D.config.maxDate &&
                    ...
                    (i.disabled =
                        !!D.config.minDate && D.config.minDate.getFullYear() === D.config.maxDate.getFullYear())));
        ...
        function ne(e) {
            ...
            if (13 === e.keyCode && t) {
                if (a)
                    return (
                        D.setDate(D._input.value, !0, n === D.altInput ? D.config.altFormat : D.config.dateFormat),
                        n.blur()
                    );
                D.open();
            } else if (G(n) || i || o) {
        ...
        function le(e) {
            if (void 0 !== D.calendarContainer) {
                ...
                if (
                    (d(D.calendarContainer, 'arrowTop', !s), d(D.calendarContainer, 'arrowBottom', s), !D.config.inline)
                ) {
        ...
        ((D.parseDate = b({ config: D.config, l10n: D.l10n })),
            ...
            (D.clear = function (e, n) {
                ...
                ((D.selectedDates = []),
                    ...
                    !0 === n &&
                        ((D.currentYear = D._initialDate.getFullYear()), (D.currentMonth = D._initialDate.getMonth())));
