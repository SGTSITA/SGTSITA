...
var FullCalendar = (function (e) {
    ...
    function w(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (l == d && (l = null != a ? a[0] : w ? S(r, 0) : null), n.__k = [], c = 0; c < t.length; c++)
            if (
                ...
                if (
                    ((g.__ = n), (g.__b = n.__b + 1), null === (h = C[c]) || (h && g.key == h.key && g.type === h.type))
                )
                    C[c] = void 0;
                else
                    for (f = 0; f < w; f++) {
            ...
            e: if ('function' == typeof R) {
                if (
                    ...
                    null != R.getDerivedStateFromProps &&
                        (d.__s == d.state && (d.__s = h({}, d.__s)), h(d.__s, R.getDerivedStateFromProps(S, d.__s))),
                    (f = d.props),
                    (v = d.state),
                    p)
                )
                    ...
                    if (
                        ...
                        (!d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(S, d.__s, b)) ||
                            t.__v === n.__v)
                    ) {
                        ((d.props = S),
                            (d.state = d.__s),
                    ...
                    return (
                        ...
                        (function (e, t, n) {
                            ...
                            return (
                                ...
                                r.length > 10 &&
                                    (null == t ? (r = r.replace('Z', '')) : 0 !== t && (r = r.replace('Z', it(t, !0)))),
                                r
                            );
                        })(e, n, t.omitTime)
                    );
    ...
    function Wi(e, t) {
        ...
        return t
            ? n
            : { start: ye(n.start, e.slotMinTime.milliseconds), end: ye(n.end, e.slotMaxTime.milliseconds - 864e5) };
    }
    ...
    function Zi(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
                n.push(
                    Ar('col', {
                        style: { width: 'shrink' === a.width ? Xi(t) : a.width || '', minWidth: a.minWidth || '' },
                    }),
                );
    ...
    function ua(e) {
        ...
        return r(
            r(r({ date: n.toDate(t), view: e.viewApi }, o), { dayNumberText: e.showDayNumber ? n.format(t, sa) : '' }),
            e.extraProps,
        );
    }
    var ca = (function (e) {
            ...
            return (
                ...
                (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
                    var a = this,
                        s = this.context,
                        l = this.props;
                    return (e = Ps(e, l.date, l.slatCoords, s.options.eventMinHeight, s.options.eventOrder)).map(
                        function (e) {
