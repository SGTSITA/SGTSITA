        ...
        QJ7E: function (t, e, n) {
                    ...
                    if (((_t = St = -(bt = Pt = 1 / 0)), (Lt = []), ht(t, At), (n = Lt.length))) {
                        for (Lt.sort(Xt), e = 1, o = [(i = Lt[0])]; e < n; ++e)
                            Yt(i, (r = Lt[e])[0]) || Yt(i, r[1])
                                ? (qt(i[0], r[1]) > qt(i[0], i[1]) && (i[1] = r[1]),
                                  qt(r[0], i[1]) > qt(i[0], i[1]) && (i[0] = r[0]))
                                : o.push((i = r));
                        for (a = -1 / 0, e = 0, i = o[(n = o.length - 1)]; e <= n; i = r, ++e)
                            ((r = o[e]), (u = qt(i[1], r[0])) > a && ((a = u), (bt = r[0]), (St = i[1])));
                    }
                    return (
                        (Lt = Ct = null),
                        bt === 1 / 0 || Pt === 1 / 0
            ...
            function me(t, e) {
                ...
                var n = F((e *= V)),
                    ...
                    o = X(e),
                    a = R(
                        U((a = ce * o - le * r) * a + (a = le * i - se * o) * a + (a = se * r - ce * i) * a),
                        se * i + ce * r + le * o,
                    );
                ((Jt += a),
                    (te += a * (se + (se = i))),
            ...
            var Me = function (t) {
                    ...
                    var e = +ie,
                        ...
                        r = W(e, n, i);
                    return r < I &&
                        ((e = te), (n = ee), (i = ne), Jt < E && ((e = Kt), (n = Qt), (i = $t)), (r = W(e, n, i)) < I)
                        ? [NaN, NaN]
                        : [R(n, e) * z, Q(i / r) * z];
                },
                xe = function (t) {
            ...
            function Te(t, e, n, i, r, o) {
                if (n) {
                    ...
                    null == r
                        ? ((r = e + i * N), (o = e - s / 2))
                        : ((r = De(a, r)), (o = De(a, o)), (i > 0 ? r < o : r > o) && (r += i * N));
            ...
            var Fe = function (t, e) {
                    ...
                    for (var c = 0, l = t.length; c < l; ++c)
                        if ((p = (h = t[c]).length))
                            for (
                                var h, p, f = h[p - 1], d = Re(f), g = f[1] / 2 + G, v = X(g), m = F(g), y = 0;
                                y < p;
                                ++y, d = P, v = M, m = x, f = b
                            ) {
                                var b = h[y],
                        ...
                        var o,
                            ...
                            p = {
                                ...
                                polygonEnd: function () {
                                    ...
                                    var t = Fe(o, i);
                                    (a.length
                                        ? (h || (r.polygonStart(), (h = !0)), Ae(a, We, t, n, r))
                                        : t &&
                                ...
                                : r !== u &&
                                  ...
                                  (i = (function (t, e, n, i) {
                                      var r,
                                          ...
                                          a = X(t - n);
                                      return A(a) > E
                                          ? k((X(e) * (o = F(i)) * X(n) - X(i) * (r = F(e)) * X(t)) / (r * o * a))
                                          : (e + i) / 2;
                                  })(n, i, o, a)),
                                  t.point(r, i),
                                  t.lineEnd(),
            ...
            var wi = function (t, e) {
                    ...
                    function o(t) {
                        return (
                            t && ('function' == typeof r && i.pointRadius(+r.apply(this, arguments)), ht(t, n(i))),
                            i.result()
                        );
                    }
                    return (
                        ...
                        (o.context = function (t) {
                            return arguments.length
                                ? ((i = null == t ? ((e = null), new xi()) : new fi((e = t))),
                              ...
                              function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
                                  ...
                                  if (b > 4 * e && g--) {
                                      ...
                                      ((T * T) / b > e ||
                                          A((m * C + y * I) / b - 0.5) > 0.3 ||
                                          a * p + u * f + s * d < zi) &&
                                          (n(i, r, o, a, u, s, O, L, j, (P /= M), (S /= M), _, g, v),
                                          v.point(O, L),
                                          n(O, L, j, P, S, _, c, l, h, p, f, d, g, v));
                                  }
                              }
                              return function (e) {
                                  var i,
                    ...
                    (O.clipExtent = function (t) {
                        return arguments.length
                            ? ((j =
                                  null == t
                                      ? ((x = i = r = o = null), Cn)
                                      : Je((x = +t[0][0]), (i = +t[0][1]), (r = +t[1][0]), (o = +t[1][1]))),
                              E())
                            : null == x
                              ? null
                              : [
            ...
            function dr(t, e) {
                var n = Q(fr * X(e)),
                    ...
                    r = i * i * i;
                return [
                    (t * F(n)) / (fr * (cr + 3 * lr * i + r * (7 * hr + 9 * pr * i))),
                    n * (cr + lr * i + r * (hr + pr * i)),
                ];
            }
                        ...
                        (b.clipExtent = function (t) {
                            return arguments.length
                                ? ((m =
                                      null == t
                                          ? ((f = n = i = r = null), Cn)
                                          : Je((f = +t[0][0]), (n = +t[0][1]), (i = +t[1][0]), (r = +t[1][1]))),
                                  y())
                                : null == f
                                  ? null
                                  : [
                    ...
                    return (
                        ...
                        Object.defineProperty(e.prototype, 'multiLine', {
                            get: function () {
                                ...
                                return (
                                    !t && this.dataItem && this.dataItem.multiLine && (t = this.dataItem.multiLine),
                                    t
                                );
                            },
                            set: function (t) {
                        ...
                        (e.prototype.getTooltipX = function () {
                            ...
                            return (
                                t instanceof go.a || (t = Object(go.c)(50)),
                                t instanceof go.a ? this.positionToPoint(t.value).x : 0
                            );
                        }),
                        (e.prototype.getTooltipY = function () {
                            ...
                            return (
                                t instanceof go.a || (t = Object(go.c)(50)),
                                t instanceof go.a ? this.positionToPoint(t.value).y : 0
                            );
                        }),
                        Object.defineProperty(e.prototype, 'precision', {
                            get: function () {
                    ...
                    return (
                        ...
                        (e.prototype.handlePanDown = function (t) {
                            ...
                            e.x > 0 &&
                                ...
                                ((this._downPointOrig = Yr.documentPointToSprite(
                                    t.pointer.point,
                        ...
                        (e.prototype.zoomToRectangle = function (t, e, n, i, r, o, a) {
                            ...
                            var p =
                                r *
                                Math.min((this.south - this.north) / (n - t), Math.abs((this.west - this.east) / h));
                        ...
                        Object.defineProperty(e.prototype, 'deltaLongitude', {
                            ...
                            set: function (t) {
                                ((t = v.round(t, 3)),
                                    this.setPropertyValue('deltaLongitude', uo(t)) &&
                                ...
                                if (g.hasValue(window['am4geodata_' + e.geodata]))
                                    ...
                                    try {
                                        ...
                                        this.raiseCriticalError(
                                            Error('MapChart error: Geodata `' + n + '` is not loaded or is incorrect.'),
                                            !0,
                                        );
                                    }
                            }
                                            ...
                                            function (n) {
                                                e.topParent.hasFocused &&
                                                    (io.b.isKey(n.event, 'plus')
                                                        ? t.zoomIn()
                                                        : io.b.isKey(n.event, 'minus') && t.zoomOut());
                                            },
                                            t,
                                        ),
            ...
            function va(t, e) {
                ...
                return n < ta
                    ? [t, Ho(Uo(ta + e / 2))]
                    : [t * Ro(n) * (2 * na - 1 / Yo(n)), Xo(e) * (2 * na * (n - ta) - Ho(Uo(n / 2)))];
            }
            ...
            xa.invert = function (t, e) {
                ...
                do {
                    ((i = r - na * Yo(o)),
                        (o -= n = (Yo(2 * o) + 2 * o - Qo * Yo(i)) / (2 * Ro(2 * o) + 2 + Qo * Ro(i) * na * Ro(o))));
                } while (Vo(n) > Jo && --a > 0);
            ...
            function Na(t, e) {
                for (var n = (1 + $o) * Yo(e), i = 0, r = 1 / 0; i < 10 && Vo(r) > Jo; i++)
                    e -= r = (e + Yo(e) - n) / (1 + Ro(e));
            ...
            function Za(t, e) {
                ...
                var u = [1, 0, 0, 0, 0, 0, 0, 0, 0],
                    ...
                    c = 0;
                for (i = ca(1 - e), a = 1; Vo(s[c] / u[c]) > Jo && c < 8; )
                    ((n = u[c++]), (s[c] = (n - i) / 2), (u[c] = (n + i) / 2), (i = ca(n * i)), (a *= 2));
                r = a * u[c] * t;
                do {
                ...
                var n = (na - 1) / (na + 1),
                    ...
                    u = (function (t, e) {
                        var n = t * t,
                            ...
                            r = 1 - n - e * e;
                        return [
                            0.5 * ((t >= 0 ? $o : -$o) - ko(r, 2 * t)),
                            -0.25 * Ho(r * r + 4 * n) + 0.5 * Ho(i * i + n),
                        ];
                    })(a * Ro(-1 * t), a * Yo(-1 * t)),
                    s = (function (t, e, n) {
                        var i = Vo(t),
            ...
            function su(t, e) {
                for (
                    var n, i = (1 + ea) * Yo(e), r = e, o = 0;
                    o < 25 && ((r -= n = (Yo(r / 2) + Yo(r) - i) / (0.5 * Ro(r / 2) + Ro(r))), !(Vo(n) < Jo));
                    o++
                );
            ...
            function cu(t, e) {
                for (
                    var n, i = ca(6 / (4 + Qo)), r = (1 + Qo / 4) * Yo(e), o = e / 2, a = 0;
                    a < 25 && ((o -= n = (o / 2 + Yo(o) - r) / (0.5 + Ro(o))), !(Vo(n) < Jo));
                    a++
                );
            ...
            cu.invert = function (t, e) {
                var n = ca(6 / (4 + Qo)),
                    i = e / n;
                return (
                    Vo(Vo(i) - $o) < Jo && (i = i < 0 ? -$o : $o),
                    [(1.5 * t) / (n * (0.5 + Ro(i))), ua((i / 2 + Yo(i)) / (1 + Qo / 4))]
                );
            };
            ...
            Su.invert = function (t, e) {
                ...
                do {
                    var r = i * i;
                    i -= n =
                        (i * (fu + r * r * (du + r * (gu + vu * r))) - e) / (mu + r * r * (yu + r * (bu + Pu * r)));
                } while (Vo(n) > Jo);
                return [t, i];
            };
            ...
            _u.invert = function (t, e) {
                ...
                return (
                    (a = Uo(r)),
                    [(Vo(e) < Vo(r + 1 / a) ? ua(t * a) : Xo(e) * Xo(t) * (sa(Vo(t * a)) + $o)) / Yo(r), r]
                );
            };
            var Mu = [
                    [0, 90],
            ...
            function Ou(t, e) {
                ...
                return [
                    ...
                    (e > 0 ? $o : -$o) * (c + (o * (h - u)) / 2 + (o * o * (h - 2 * c + u)) / 2),
                ];
            }
            ...
            function Cu(t, e) {
                ...
                var r = Ro(i),
                    ...
                    p = a + u;
                return [
                    (Xo(t) * Qo * (o * h + ca(a * h * h - l * (u * u - c)))) / l,
                    (Xo(e) * Qo * (s * p - o * ca((a + 1) * l - p * p))) / l,
                ];
            }
            Cu.invert = function (t, e) {
                if (Vo(e) < Jo) return [t, 0];
                ...
                var n = (t /= Qo) * t,
                    ...
                    p = sa((3 * c) / (l * h)) / 3;
                return [
                    (Qo * (r - 1 + ca(1 + 2 * (n - i) + o))) / (2 * t),
                    Xo(e) * Qo * (-h * Ro(p + Qo / 3) - u / (3 * s)),
                ];
            };
            ...
            Eu.invert = function (t, e) {
                ...
                return [
                    Xo(t) * Qo * (r - i),
                    Xo(e) * $o * Yo(2 * ko(ca((1 - 2 * i * n) * (i + r) - n), ca(r + i + n))),
                ];
            };
            ...
            function Tu(t, e) {
                ...
                var i = n / $o,
                    ...
                    d =
                        (p * (s + a - 1) +
                            2 * ca(s * (r + a * f - 1) + (1 - r) * (r * (c * c + 4 * a) + 12 * u * a + 4 * a * a))) /
                        (4 * s + f);
                            ...
                            value: function (t) {
                                for (var e = this.data, n = this.compare, i = this.length >> 1, r = e[t]; t < i; ) {
                                    var o = 1 + (t << 1),
                                        a = e[o],
                                        u = o + 1;
                                    if ((u < this.length && n(e[u], a) < 0 && ((o = u), (a = e[u])), n(a, r) >= 0))
                                        break;
                                    ((e[t] = a), (t = o));
                                }
                                e[t] = r;
        ...
        'o+vr': function (t, e, n) {
            ...
            function r(t, e, n) {
                ...
                for (var _ = m.length; m.length; ) {
                    var M = m.pop();
                    (M.d > P.d &&
                        ((P = M), n && console.log('found best %d after %d probes', Math.round(1e4 * M.d) / 1e4, _)),
                        M.max - P.d <= e ||
                            ((g = M.h / 2),
