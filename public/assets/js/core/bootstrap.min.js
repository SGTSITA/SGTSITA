...
!(function (t, e) {
    ...
    class xt extends R {
        ...
        _selectMenuItem({ key: t, target: e }) {
            const i = Y.find('.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)', this._menu).filter((t) =>
                h(t),
            );
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ('click' === e)
                    ...
                    const t =
                            e === Le ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
                        i =
                            e === Le
