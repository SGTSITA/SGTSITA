...
(function () {
    ...
    [].slice.call(document.querySelectorAll('div.highlight')).forEach(function (element) {
    ...
    [].slice.call(document.querySelectorAll('[href="javascript:void(0);"]')).forEach(function (link) {
