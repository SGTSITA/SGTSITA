...
!(function (t, e) {
        ...
        show() {
            ...
            if (!P.trigger(this._element, 'show.bs.dropdown', e).defaultPrevented) {
                ...
                ('ontouchstart' in document.documentElement &&
                    ...
                    [].concat(...document.body.children).forEach((t) => P.on(t, 'mouseover', null, function () {})),
                    this._element.focus(),
        ...
        _transitionComplete(t, e, s) {
            ...
            (t.classList.add('active'),
                ...
                t.parentNode &&
                    ...
                    (t.closest('.dropdown') && U.find('.dropdown-toggle').forEach((t) => t.classList.add('active')),
    ...
    class $t extends M {
        ...
        _getConfig(t) {
            return (
                (t = { ...Wt, ...$.getDataAttributes(this._element), ...('object' == typeof t && t ? t : {}) }),
