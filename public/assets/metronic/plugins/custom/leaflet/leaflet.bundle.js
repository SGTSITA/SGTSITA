...
(!(function (t, e) {
                    ...
                    if (1 === arguments.length) {
                        ...
                        'function' != typeof e
                            ...
                            : !1 !== (e = this._listens(t, e, i)) &&
                              ((i = n[e]),
                              this._firingCount && ((i.fn = l), (this._events[t] = n = n.slice())),
                              n.splice(e, 1));
            },
            fire: function (t, i, n) {
                if (this.listens(t, n)) {
    ...
    ((k.prototype = {
        ...
        (Z.prototype = {
            extend: function (t) {
                var e, i;
                if (t) {
                    if (t instanceof k || 'number' == typeof t[0] || 'x' in t) e = i = E(t);
            ...
            getCenter: function (t) {
                return E((this.min.x + this.max.x) / 2, (this.min.y + this.max.y) / 2, t);
            },
            ...
            contains: function (t) {
                var e, i;
                return (
                    (t = ('number' == typeof t[0] || t instanceof k ? E : B)(t)) instanceof Z
                        ? ((e = t.min), (i = t.max))
                        : (e = i = t),
    ...
    var Mt = {
        ...
        Et = {
            touchstart: function (t, e) {
                (e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && ze(e), Nt(t, e));
            },
            touchmove: Nt,
            touchend: Nt,
            touchcancel: Nt,
    ...
    var jt,
        ...
        Ht,
        Vt,
        Kt = ue(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
        Jt = ue(['webkitTransition', 'transition', 'OTransition', 'MozTransition', 'msTransition']),
    ...
    function de(t, e) {
        ((t._leaflet_pos = e), Mt.any3d ? ce(t, e) : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px')));
    }
    function pe(t) {
    ...
    function fe(t) {
        ...
        t.style &&
            (ge(), (Vt = (Ht = t).style.outlineStyle), (t.style.outlineStyle = 'none'), xe(window, 'keydown', ge));
    }
    function ge() {
        Ht && ((Ht.style.outlineStyle = Vt), (Vt = Ht = void 0), we(window, 'keydown', ge));
    }
    function ve(t) {
    ...
    ((Wt =
        'onselectstart' in document
            ...
            : ((Gt = ue(['userSelect', 'WebkitUserSelect', 'OUserSelect', 'MozUserSelect', 'msUserSelect'])),
              (qt = function () {
                  var t;
                  Gt && ((t = document.documentElement.style), (jt = t[Gt]), (t[Gt] = 'none'));
              }),
              function () {
    ...
    var Pe = { mouseenter: 'mouseover', mouseleave: 'mouseout', wheel: !('onwheel' in window) && 'mousewheel' };
    function Te(t, e, i, n) {
        var o,
            s,
            a = e + r(i) + (n ? '_' + r(n) : '');
                ...
                ? (o = (function (t, e, i) {
                      return (
                          'touchstart' !== e ||
                              ...
                              (Bt = !0)),
                          Et[e]
                              ? ((i = Et[e].bind(this, i)), t.addEventListener(Ot[e], i, !1), i)
                ...
                : Mt.touch && 'dblclick' === e
                  ...
                  : 'addEventListener' in t
                    ? 'touchstart' === e || 'touchmove' === e || 'wheel' === e || 'mousewheel' === e
                        ? t.addEventListener(Pe[e] || e, o, !!Mt.passiveEvents && { passive: !1 })
        ...
        ((o = o || e + r(i) + (n ? '_' + r(n) : '')),
            (i = t[be] && t[be][o]) &&
                (!Mt.touchNative && Mt.pointer && 0 === e.indexOf('touch')
                    ? ((n = t),
                      (a = i),
                      Ot[(s = e)] ? n.removeEventListener(Ot[s], a, !1) : console.warn('wrong event specified:', s))
                    : Mt.touch && 'dblclick' === e
                      ? ((n = i),
    ...
    function Ae(t) {
        return (xe(t, 'mousedown touchstart dblclick contextmenu', Ce), (t._leaflet_disable_click = !0), this);
    }
    function ze(t) {
    ...
    function Oe(t, e) {
        ...
        return e
            ? ((n = (i = ye(e)).boundingClientRect),
              new k((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop))
        ...
        De = I.extend({
            ...
            initialize: function (t, e) {
                ((e = p(this, e)),
                    ...
                    this.callInitHooks(),
                    (this._zoomAnimated = Jt && Mt.any3d && !Mt.mobileOpera && this.options.zoomAnimation),
                    this._zoomAnimated &&
                        (this._createAnimProxy(), xe(this._proxy, Yt, this._catchTransitionEnd, this)),
            ...
            panInside: function (t, e) {
                var i = E((e = e || {}).paddingTopLeft || e.padding || [0, 0]),
                    ...
                    s =
                        ((t = this.project(t)),
                        (i = B([(s = this.getPixelBounds()).min.add(i), s.max.subtract(n)])).getSize());
                return (
                    i.contains(t) ||
                        ((this._enforcingBounds = !0),
            ...
            containerPointToLatLng: function (t) {
                return ((t = this.containerPointToLayerPoint(E(t))), this.layerPointToLatLng(t));
            },
            ...
            _initContainer: function (t) {
                if (!(t = this._container = Qt(t))) throw new Error('Map container not found.');
                    ...
                    for (
                        ...
                        if (
                            ...
                            l.originalEvent._stopped ||
                                (!1 === o[r].options.bubblingMouseEvents && -1 !== v(this._mouseEvents, i)))
                        )
                            return;
                }
            },
            ...
            _getBoundsOffset: function (t, e, i) {
                return (
                    (i = (e = B(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i))).min.subtract(
                        t.min,
                    )),
            ...
            _tryAnimatedPan: function (t, e) {
                return (
                    ...
                    !((!0 !== (e && e.animate) && !this.getSize().contains(t)) || (this.panBy(t, e), 0))
                );
            },
    ...
    var Ne = A.extend({
        ...
        Ue =
            ...
            Ne.extend({
                    ...
                    var t = 'leaflet-control-layers',
                        ...
                        o =
                            (i &&
                                ...
                                xe(e, { mouseenter: this._expandSafely, mouseleave: this.collapse }, this)),
                ...
                _expandSafely: function () {
                    var t = this._section,
                        e = ((this._preventClick = !0), xe(t, 'click', ze), this.expand(), this);
                    setTimeout(function () {
            ...
            _updateDisabled: function () {
                ...
                (re(this._zoomInButton, e),
                    ...
                    (!this._disabled && t._zoom !== t.getMinZoom()) ||
                        (se(this._zoomOutButton, e), this._zoomOutButton.setAttribute('aria-disabled', 'true')),
                    (!this._disabled && t._zoom !== t.getMaxZoom()) ||
                        (se(this._zoomInButton, e), this._zoomInButton.setAttribute('aria-disabled', 'true')));
            },
        }),
        Ge =
        ...
        He = I.extend({
            ...
            enable: function () {
                this._enabled || (xe(this._dragStartTarget, We, this._onDown, this), (this._enabled = !0));
            },
            disable: function () {
                this._enabled &&
            ...
            finishDrag: function (t) {
                (re(document.body, 'leaflet-dragging'),
                    this._lastTarget && (re(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null)),
    ...
    function Ve(t, e, i) {
        for (var n, o, s, r, a, h, l, u = [1, 4, 2, 8], c = 0, d = t.length; c < d; c++) t[c]._code = ei(t[c], e);
        for (s = 0; s < 4; s++) {
            for (h = u[s], n = [], c = 0, o = (d = t.length) - 1; c < d; o = c++)
                ((r = t[c]),
                    (a = t[o]),
                    r._code & h
                        ? a._code & h || (((l = ti(a, r, h, e, i))._code = ei(l, e)), n.push(l))
                        : (a._code & h && (((l = ti(a, r, h, e, i))._code = ei(l, e)), n.push(l)), n.push(r)));
            t = n;
        }
        return t;
    }
    function Ke(t, e) {
        ...
        for (p = r = a = h = 0, i = c - 1; p < c; i = p++)
            ((n = d[p]),
                ...
                (h += (n.y + o.y) * s),
                (r += 3 * s));
        return ((u = 0 === r ? d[0] : [a / r, h / r]), N([(u = e.unproject(E(u))).lat + l.lat, u.lng + l.lng]));
    }
    function Je(t) {
            ...
            ((o[0] = o[n - 1] = 1),
                (function t(e, i, n, o, s) {
                    var r,
                        ...
                        h,
                        l = 0;
                    for (a = o + 1; a <= s - 1; a++) l < (h = ii(e[a], e[o], e[s], !0)) && ((r = a), (l = h));
    ...
    function $e(t, e, i, n, o) {
        ...
        for (Ye = l; ; ) {
            if (!(h | l)) return [t, e];
            if (h & l) return !1;
            ((a = ei((r = ti(t, e, (s = h || l), i, o)), i)), s === h ? ((t = r), (h = a)) : ((e = r), (l = a)));
        }
    }
    ...
    var ri = e({}, j, { code: 'EPSG:4326', projection: nt, transformation: W(1 / 180, 1, -1 / 180, 0.5) }),
        ai =
            ((ht = e({}, U, {
                projection: nt,
        ...
        li = A.extend({
            ...
            _setIconStyles: function (t, e) {
                var i = this.options,
                    ...
                    o = E(('shadow' === e && i.shadowAnchor) || i.iconAnchor || (n && n.divideBy(2, !0)));
        ...
        ui = li.extend({
            ...
            _getIconUrl: function (t) {
                return (
                    'string' != typeof ui.imagePath && (ui.imagePath = this._detectIconPath()),
        ...
        ci = $.extend({
            ...
            _onPreDrag: function (t) {
                this._marker.options.autoPan &&
                    (C(this._panRequest), (this._panRequest = S(this._adjustPan.bind(this, t))));
            },
            _onDrag: function (t) {
                var e = this._marker,
                    i = e._shadow,
        ...
        di = lt.extend({
            ...
            _panOnFocus: function () {
                var t,
                    ...
                    i = this._map;
                i &&
                    ((t = (e = this.options.icon.options).iconSize ? E(e.iconSize) : E(0, 0)),
        ...
        mi = _i.extend({
            ...
            closestLayerPoint: function (t) {
                for (var e = 1 / 0, i = null, n = ii, o = 0, s = this._parts.length; o < s; o++)
            ...
            _updateBounds: function () {
                ...
                this._rawPxBounds &&
                    (this._pxBounds = new Z([this._rawPxBounds.min.subtract(t), this._rawPxBounds.max.add(t)]));
            },
    ...
    var gi = fi.extend({
            ...
            _setLatLngs: function (t) {
                (fi.prototype._setLatLngs.call(this, t), ni(this._latlngs) && (this._latlngs = [this._latlngs]));
            },
            _defaultShape: function () {
    ...
    var Mi = lt.extend({
            ...
            _reset: function () {
                var t = this._image,
                    ...
                    i = e.getSize();
                (de(t, e.min), (t.style.width = i.x + 'px'), (t.style.height = i.y + 'px'));
            },
            _updateOpacity: function () {
        ...
        Ii = lt.extend({
            ...
            initialize: function (t, e) {
                (t && (t instanceof F || g(t)) ? ((this._latlng = N(t)), p(this, e)) : (p(this, t), (this._source = e)),
            ...
            onAdd: function (t) {
                ((this._zoomAnimated = t._zoomAnimated),
                    ...
                    this.bringToFront(),
                    this.options.interactive &&
                        (se(this._container, 'leaflet-interactive'), this.addInteractiveTarget(this._container)));
            },
            onRemove: function (t) {
                (t._fadeAnimated
                    ? (le(this._container, 0), (this._removeTimeout = setTimeout(o(te, void 0, this._container), 200)))
                    : te(this._container),
                    this.options.interactive &&
                        (re(this._container, 'leaflet-interactive'), this.removeInteractiveTarget(this._container)));
            },
            getLatLng: function () {
                return this._latlng;
            },
        ...
        ki =
            ...
            Ii.extend({
                ...
                _initLayout: function () {
                    ...
                    ((this._contentNode = $t('div', t + '-content', i)),
                        ...
                        this.options.closeButton &&
                            ((i = this._closeButton = $t('a', t + '-close-button', e)).setAttribute('role', 'button'),
                ...
                _updateLayout: function () {
                    ...
                    ((n && n < i ? ((e.height = n + 'px'), se) : re)(t, 'leaflet-popup-scrolled'),
            ...
            li.extend({
                ...
                createIcon: function (t) {
                    ...
                    return (
                        ...
                        e.bgPos && ((e = E(e.bgPos)), (t.style.backgroundPosition = -e.x + 'px ' + -e.y + 'px')),
    ...
    var Zi = lt.extend({
            ...
            _updateOpacity: function () {
                if (this._map && !Mt.ielt9) {
                    ...
                    (n && !this._noPrune && this._pruneTiles(),
                        i && (C(this._fadeFrame), (this._fadeFrame = S(this._updateOpacity, this))));
                }
            },
            _onOpaqueTile: l,
            ...
            _invalidateAll: function () {
                for (var t in this._levels)
                    (te(this._levels[t].el), this._onRemoveLevel(Number(t)), delete this._levels[t]);
                (this._removeAllTiles(), (this._tileZoom = void 0));
            },
            _retainParent: function (t, e, i, n) {
                i -= 1;
                var o =
                    (((o = new k(+(t = Math.floor(t / 2)), +(e = Math.floor(e / 2)))).z = i), this._tileCoordsToKey(o));
                    ...
                    if ((void 0 === t && (t = n.getCenter()), void 0 !== this._tileZoom)) {
                        var i,
                            ...
                            a =
                                ...
                                new Z(o.getBottomLeft().subtract([n, -n]), o.getTopRight().add([n, -n])));
            ...
            _tileReady: function (t, e, i) {
                ...
                (i = this._tiles[n]) &&
                    ...
                    this._map._fadeAnimated
                        ? (le(i.el, 0), C(this._fadeFrame), (this._fadeFrame = S(this._updateOpacity, this)))
                        : ((i.active = !0), this._pruneTiles()),
                    e || (se(i.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: i.el, coords: t })),
                    this._noTilesToLoad() &&
                        ((this._loading = !1),
                        this.fire('load'),
        ...
        Bi = Zi.extend({
            ...
            _removeTile: function (t) {
                var e = this._tiles[t];
                if (e) return (e.el.setAttribute('src', y), Zi.prototype._removeTile.call(this, t));
            },
            _tileReady: function (t, e, i) {
    ...
    var Fi = lt.extend({
            ...
            onAdd: function () {
                (this._container || (this._initContainer(), se(this._container, 'leaflet-zoom-animated')),
                    this.getPane().appendChild(this._container),
                    this._update(),
        ...
        Ni = Fi.extend({
            ...
            _requestRedraw: function (t) {
                this._map &&
                    (this._extendRedrawBounds(t), (this._redrawRequest = this._redrawRequest || S(this._redraw, this)));
            },
    ...
    var ji = (function () {
        ...
        qi = Fi.extend({
            ...
            _removePath: function (t) {
                (te(t._path), t.removeInteractiveTarget(t._path), delete this._layers[r(t)]);
            },
            _updatePath: function (t) {
    ...
    ((Y = $.extend({
        ...
        _onMouseMove: function (t) {
            ...
            (de(this._box, t.min), (this._box.style.width = e.x + 'px'), (this._box.style.height = e.y + 'px'));
        },
        _finish: function () {
    ...
    var Vi =
        ...
        Ki =
                ...
                $.extend({
                    ...
                    addHooks: function () {
                        ...
                        (t.tabIndex <= 0 && (t.tabIndex = '0'),
                            xe(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
                        ...
                        if (!(t.altKey || t.ctrlKey || t.metaKey)) {
                            ...
                            if (n in this._panKeys)
                                (o._panAnim && o._panAnim._inProgress) ||
                                    ...
                                    o.options.maxBounds && (i = o._limitOffset(E(i), o.options.maxBounds)),
            ...
            (mt =
                ...
                De.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 }),
                $.extend({
                    addHooks: function () {
                    ...
                    _onWheelScroll: function (t) {
                        ...
                        (clearTimeout(this._timer), (this._timer = setTimeout(o(this._performZoom, this), e)), Ie(t));
                    },
            ...
            (ft =
                ...
                De.mergeOptions({ tapHold: Mt.touchNative && Mt.safari && Mt.mobile, tapTolerance: 15 }),
                $.extend({
                    addHooks: function () {
    ...
    (function (t, e) {
        'object' == typeof exports && 'undefined' != typeof module
            ...
            : 'function' == typeof define && define.amd
              ...
              : e(
                    (((t = 'undefined' != typeof globalThis ? globalThis : t || self).L = t.L || {}), (t.L.esri = {})),
                    t.L,
                );
    })(this, function (t, e) {
        'use strict';
        ...
        function u(t, e, i, n) {
            ...
            return (
                ...
                null != n &&
                    void 0 !== n.options &&
                    ((o.timeout = n.options.timeout), n.options.withCredentials && (o.withCredentials = !0)),
                o.send(null),
                o
            );
        }
        function c(t, e, i, n) {
            ...
            if (
                ...
                null != n &&
                    void 0 !== n.options &&
                    ((r.timeout = n.options.timeout), n.options.withCredentials && (r.withCredentials = !0)),
                l <= 2e3 && o.cors)
            )
                r.send(null);
            else {
            ...
            return (
                ...
                (h.onerror = function (t) {
                    t &&
                        ...
                        (n.call(o, { error: { code: 500, message: 'An unknown error occurred' } }),
                        (window._EsriLeafletCallbacks[s] = !0));
                }),
        ...
        var m = { request: c, get: p, post: l },
            ...
            g = function (t, e) {
                for (var i = 0; i < t.length - 1; i++)
                    for (var n = 0; n < e.length - 1; n++) if (f(t[i], t[i + 1], e[n], e[n + 1])) return !0;
                return !1;
            },
            v = function (t) {
                return (
            ...
            return t instanceof e.LatLngBounds
                ...
                : (t.getLatLng && (t = t.getLatLng()),
                  ...
                  t instanceof e.GeoJSON &&
                      ((t = t.getLayers()[0].feature.geometry), (i.geometry = T(t)), (i.geometryType = B(t.type))),
            ...
            if (i && i.attributionControl) {
                ...
                if (o && n) {
                    for (
                        var s = '',
                            r = i.getBounds(),
                            a = e.latLngBounds(r.getSouthWest().wrap(), r.getNorthEast().wrap()),
                            h = i.getZoom(),
                            l = 0;
                        l < n.length;
                        l++
                    ...
                    ((s = 'Powered by <a href="https://www.esri.com">Esri</a> | ' + s.substr(2)),
                        (o.innerHTML = s),
        ...
        var G = {
            ...
            W = q.extend({
                ...
                run: function (t, e) {
                    return (
                        this._cleanParams(),
                        this.options.isModern || (Z(this.options.url) && void 0 === this.options.isModern)
        ...
        var X = J.extend({
            ...
            _responseToGeoJSON: function (t) {
                ...
                if (
                    ...
                    i && i.features && ((o.catalogItems = k(i)), n && n.length === o.catalogItems.features.length))
                )
                    ...
                    return e.Util.bind(function (r, a) {
                        (!r ||
                            ...
                            r
                                ...
                                : this.fire(
                                      'requestsuccess',
                                      { url: this.options.url + i, params: n, response: a, method: t },
                                      !0,
                                  ),
            ...
            addFeatures: function (t, e, i) {
                ...
                return (
                    ...
                    this.post(
                        ...
                        function (t, n) {
                            var o =
                                n && n.addResults ? (n.addResults.length > 1 ? n.addResults : n.addResults[0]) : void 0;
        ...
        var at = 'https:' !== window.location.protocol ? 'http:' : 'https:',
                ...
                onAdd: function (t) {
                    (D(t),
                        ...
                        this.options.attributionUrl &&
                            U((this.options.proxy ? this.options.proxy + '?' : '') + this.options.attributionUrl, t),
                        t.on('moveend', j),
                        e.TileLayer.prototype.onAdd.call(this, t));
                },
                onRemove: function (t) {
                    (F(t), t.off('moveend', j), e.TileLayer.prototype.onRemove.call(this, t));
                },
                _initPane: function () {
            ...
            lt = e.TileLayer.extend({
                ...
                createTile: function (t, i) {
                    ...
                    return (
                        ...
                        (n.alt = ''),
                        !this._lodMap || (this._lodMap && void 0 !== this._lodMap[this._getZoomForUrl()])
            ...
            ct = e.Layer.extend({
                ...
                bringToBack: function () {
                    return (
                        ...
                        this._currentImage && (this._currentImage.bringToBack(), this._setAutoZIndex(Math.min)),
                        this
                    );
                },
                setZIndex: function (t) {
                ...
                _update: function () {
                    if (this._map) {
                        ...
                        if (
                            !(this._animatingZoom || (this._map._panTransition && this._map._panTransition._inProgress))
                        )
            ...
            dt = ct.extend({
                ...
                initialize: function (t) {
                    ((t = E(t)), (this.service = ot(t)), this.service.addEventParent(this), e.Util.setOptions(this, t));
                },
            ...
            pt = ct.extend({
                ...
                initialize: function (t) {
                    ((t = E(t)), (this.service = it(t)), this.service.addEventParent(this), e.Util.setOptions(this, t));
                },
            ...
            _t = e.Layer.extend({
                ...
                getEvents: function () {
                    ...
                    return (
                        this.options.updateWhenIdle ||
                            (this._onMove ||
                                (this._onMove = e.Util.throttle(this._onMoveEnd, this.options.updateInterval, this)),
                            (t.move = this._onMove)),
                        t
                    );
                },
                ...
                _retainParent: function (t, i, n, o) {
                    ...
                    return u && u.active
                        ? ((u.retain = !0), !0)
                        : (u && u.loaded && (u.retain = !0), a > o && this._retainParent(s, r, a, o));
                },
                _retainChildren: function (t, i, n, o) {
                    for (var s = 2 * t; s < 2 * t + 2; s++)
                        for (var r = 2 * i; r < 2 * i + 2; r++) {
                            ...
                            l && l.active
                                ? (l.retain = !0)
                                : (l && l.loaded && (l.retain = !0), n + 1 < o && this._retainChildren(s, r, n + 1, o));
                        }
                },
                _resetView: function (t) {
        ...
        ((mt.prototype.query = function (t) {
            ...
            (mt.prototype.between = function (t, e) {
                ...
                return (
                    this.values[n] && this.values[n].value === e && this.values[n + 1] && n++,
        ...
        var ft = _t.extend({
                ...
                onRemove: function (t) {
                    return (F(t), t.off('zoomend', this._handleZoomChange, this), _t.prototype.onRemove.call(this, t));
                },
                getAttribution: function () {
                    return this.options.attribution;
                },
                    ...
                    for (
                        var o = [],
                            ...
                            h = e.Util.bind(function (h, l) {
                                if ((h && (a = h), l))
                                    for (var u = l.features.length - 1; u >= 0; u--) s.push(l.features[u].id);
                                --r <= 0 &&
                                    this._visibleZoom() &&
                ...
                _buildTimeIndexes: function (t) {
                    ...
                    if (this.options.timeField.start && this.options.timeField.end) {
                        ...
                        var s = [];
                        for (e = t.length - 1; e >= 0; e--)
                            ((i = t[e]), s.push({ id: i.id, value: new Date(i.properties[this.options.timeField]) }));
                ...
                deleteFeatures: function (t, e, i) {
                    return this.service.deleteFeatures(
                        ...
                        function (t, n) {
                            var o = n.length ? n : [n];
                            if (!t && o.length > 0)
                                for (var s = o.length - 1; s >= 0; s--) this.removeLayers([o[s].objectId], !0);
                            e && e.call(i, t, n);
                        },
                        this,
                    );
            ...
            gt = ft.extend({
                ...
                removeLayers: function (t, e) {
                    for (var i = t.length - 1; i >= 0; i--) {
                        var n = t[i],
                            o = this._layers[n];
                        (o &&
                            (this.fire('removefeature', { feature: o.feature, permanent: e }, !0),
                ...
                openPopup(t) {
                    return (
                        this._popup && this._popup._prepareOpen(t || this._latlng) && this._popup.openOn(this._map),
                        this
                    );
                },
                openTooltip(t) {
            ...
            run: function (t, i) {
                return (
                    ...
                    this.request(function (n, o) {
                        var s;
                        ((s = n ? void 0 : { latlng: e.latLng(o.location.y, o.location.x), address: o.address }),
                            t.call(i, n, s, o));
                    }, this)
                );
            },
                            ...
                            (s--,
                                e ||
                                    ...
                                    s <= 0 &&
                                        ...
                                        this.fire(
                                            'results',
                                            { results: r, bounds: o, latlng: o ? o.getCenter() : void 0, text: t },
                                            !0,
                                        ),
                ...
                _boundsFromResults: function (t) {
                    if (t.length) {
                        for (var i = e.latLngBounds([0, 0], [0, 0]), n = [], o = [], s = t.length - 1; s >= 0; s--) {
                            var r = t[s];
                            (o.push(r.latlng),
                                r.bounds && r.bounds.isValid() && !r.bounds.equals(i) && n.push(r.bounds));
                        }
                    ...
                    n.run(function (t, e, n) {
                        ...
                        if (!t)
                            for (; n.suggestions.length && o.length <= this.options.maxResults - 1; ) {
                                ...
                                s.isCollection ||
                                    o.push({ text: s.text, unformattedText: s.text, magicKey: s.magicKey });
                            }
                        i(t, o);
                    }, this)
                );
                ...
                _renderSuggestions: function (t) {
                    ...
                    (this.getPosition().indexOf('top') > -1 &&
                        (this._suggestions.style.maxHeight =
                            this._map.getSize().y - this._suggestions.offsetTop - this._wrapper.offsetTop - 10 + 'px'),
