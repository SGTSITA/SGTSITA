        ...
        (!c &&
            ...
            (e.jstree.core.prototype = {
                        ...
                        this._load_node(
                            ...
                            function (r) {
                                ...
                                (t.state.loaded &&
                                    ...
                                    d
                                        ? '#' !== t.id && a.addClass(t.state.opened ? 'jstree-open' : 'jstree-closed')
                ...
                open_all: function (t, i, r) {
                    ...
                    ((r = r || o),
                        (n = this),
                        (o = this.is_closed(t) ? o.find('.jstree-closed').addBack() : o.find('.jstree-closed')).each(
                            function () {
                                n.open_node(
                                    this,
                                    function (e, t) {
                ...
                deselect_node: function (t, i, r) {
                    ...
                    ((n = this.get_node(t, !0)),
                        t.state.selected &&
                            ...
                            n.length &&
                                n.children('.jstree-anchor').removeClass('jstree-clicked').attr('aria-selected', !1),
                ...
                create_node: function (i, r, s, a, n) {
                    ...
                    if ((!0 === r.id && delete r.id, !(r = this._parse_model_from_json(r, i.id, i.parents.concat()))))
                        return !1;
                    for (
                        o = this.get_node(r),
                            (d = []).push(r),
                ...
                move_node: function (i, r, s, a, n, o, d) {
                    ...
                    switch (
                        (r.id === e.jstree.root && ('before' === s && (s = 'first'), 'after' === s && (s = 'last')), s)
                    ) {
                        case 'before':
                ...
                copy_node: function (i, r, s, a, n, o, d) {
                    ...
                    if ((!0 === f.id && delete f.id, !(f = this._parse_model_from_json(f, m.id, m.parents.concat()))))
                        return !1;
                    for (
                        _ = this.get_node(f),
                ...
                cut: function (t) {
                    if ((t || (t = this._data.core.selected.concat()), e.vakata.is_array(t) || (t = [t]), !t.length))
                        return !1;
                    var i,
                        n,
                        o,
                ...
                copy: function (i) {
                    if ((i || (i = this._data.core.selected.concat()), e.vakata.is_array(i) || (i = [i]), !i.length))
                        return !1;
                    var n,
                        o,
                        d,
                ...
                return (
                    t &&
                        ...
                        e.each(t.attributes, function (t, s) {
                            -1 ===
                                e.inArray(s.name.toLowerCase(), ['style', 'contenteditable', 'hasfocus', 'tabindex']) &&
                                null !== s.value &&
            ...
            (e.jstree.plugins.checkbox = function (i, r) {
                ((this.bind = function () {
                                                ...
                                                for (s = 0, a = h.length; s < a; s++)
                                                    if (c[h[s]].state[g ? 'selected' : 'checked']) {
                                                        for (n = 0, o = c[h[s]].children_d.length; n < o; n++)
                                                            c[c[h[s]].children_d[n]].state[g ? 'selected' : 'checked'] =
                                                                !0;
                    ...
                    (this.get_state = function () {
                        ...
                        return (
                            this.settings.checkbox.tie_selection || (e.checkbox = this._data.checkbox.selected.slice()),
                            e
                        );
                    }),
                            ...
                            if (N && N._data && N._data.dnd)
                                if (
                                    ...
                                    d.helper
                                        ...
                                        .first()
                                        [w ? 'show' : 'hide'](),
                                    (d.event.target !== N.element[0] && d.event.target !== N.get_container_ul()[0]) ||
                                ...
                                if (s[r].a_attr.hasOwnProperty(c)) {
                                    ...
                                    _[i.id].a_attr[c] === t
                                        ? ((_[i.id].a_attr[c] = s[r].a_attr[c]),
                                          h && ('class' === c ? h.addClass(s[r].a_attr[c]) : h.attr(c, s[r].a_attr[c])))
                                        : 'href' === c && '#' === _[i.id].a_attr[c]
                                          ? ((_[i.id].a_attr.href = s[r].a_attr.href),
                                            h && h.attr('href', s[r].a_attr.href))
                                          : 'class' === c &&
                                            ((_[i.id].a_attr.class = s[r].a_attr.class + ' ' + _[i.id].a_attr.class),
                ...
                ((this.check = function (t, i, s, a, n) {
                    ...
                    for (o = 0, d = s.children.length; o < d; o++)
                        ((c = g[s.children[o]].text),
                            ...
                            h.push(c));
                    switch (
                        (_ || (l = l.toLowerCase()), u && (l = l.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '')), t)
                    ) {
                        case 'delete_node':
                            return !0;
                        case 'rename_node':
