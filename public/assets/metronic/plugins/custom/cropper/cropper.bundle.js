    ...
    var At = {
            ...
            renderCanvas: function (t, e) {
                ...
                ((i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
                    ...
                    ft(
                        this.canvas,
                        pt({ width: i.width, height: i.height }, zt({ translateX: i.left, translateY: i.top })),
                    ),
                    this.renderImage(t),
            ...
            renderImage: function (t) {
                ...
                (pt(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
                    ft(
                        this.image,
                        pt({ width: i.width, height: i.height }, zt(pt({ translateX: i.left, translateY: i.top }, i))),
                    ),
                    t && this.output());
            },
            ...
            renderCropBox: function () {
                ...
                ((i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
                    ...
                    t.movable &&
                        t.cropBoxMovable &&
                        Ct(this.face, N, i.width >= e.width && i.height >= e.height ? g : u),
                    ft(
                        this.cropBox,
                        pt({ width: i.width, height: i.height }, zt({ translateX: i.left, translateY: i.top })),
                    ),
        ...
        It = {
            bind: function () {
                ...
                (st(e.cropstart) && Ot(t, A, e.cropstart),
                    ...
                    e.zoomable &&
                        e.zoomOnWheel &&
                        Ot(i, K, (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
                    e.toggleDragModeOnDblclick && Ot(i, P, (this.onDblclick = this.dblclick.bind(this))),
            ...
            dblclick: function () {
                ...
                this.disabled ||
                    ...
                    this.setDragMode(
                        ((t = this.dragBox),
                        (e = B),
                        (t.classList ? t.classList.contains(e) : t.className.indexOf(e) > -1) ? Y : z),
                    );
            },
            wheel: function (t) {
                var e = this,
                ...
                if (!this.disabled) {
                    ...
                    (t.changedTouches
                        ...
                        e &&
                            ...
                            this.cropping &&
                                ((this.cropping = !1), bt(this.dragBox, W, this.cropped && this.options.modal)),
                ...
                switch (s) {
                    ...
                    case m:
                        ...
                        ((i = Et(this.cropper)),
                            ...
                            Y.y < 0 && (d -= B),
                            this.cropped ||
                                (wt(this.cropBox, O), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0)));
                }
                (L &&
                    ((r.width = p), (r.height = B), (r.left = l), (r.top = d), (this.action = s), this.renderCropBox()),
                    dt(h, function (t) {
        ...
        $t = {
            ...
            getData: function () {
                ...
                return (
                    ...
                    i.scalable && ((t.scaleX = a.scaleX || 1), (t.scaleY = a.scaleY || 1)),
                    t
                );
            },
            setData: function (t) {
                            ...
                            if (a > 1) {
                                this.url = (function (t, e) {
                                    for (var i = [], a = new Uint8Array(t); a.length > 0; )
                                        (i.push(Rt.apply(null, lt(a.subarray(0, 8192)))), (a = a.subarray(8192)));
