!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(['exports'], e)
          : e(((t = 'undefined' != typeof globalThis ? globalThis : t || self).Draggable = {}));
})(this, function (t) {
    'use strict';
    class e {
        constructor(t) {
    ...
    class s {
        constructor(t = [], e = {}) {
            ((this.containers = [...t]),
                ...
                (this.delay = (function (t) {
                    ...
                    if ('number' == typeof t) {
                        for (const r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = t);
                        return e;
                    }
                    for (const r in n)
        ...
        trigger(t, e) {
            ...
            return ((r.detail = e), r.initEvent(e.type, !0, !0), t.dispatchEvent(r), (this.lastEvent = e), e);
        }
    }
    function i(t, e) {
        ...
        let n = t;
        do {
            if (((n = n.correspondingUseElement || n.correspondingElement || n), r(n))) return n;
            n = n?.parentNode || null;
    ...
    class E extends s {
        ...
        [p](t) {
            ...
            if (!e) return;
            if (this.options.handle && t.target && !i(t.target, this.options.handle)) return;
        ...
        [y](t) {
            ...
            if ((Object.assign(this, { pageX: e, pageY: r }), !this.currentContainer)) return;
            const o = Date.now() - this.onMouseDownAt,
                l = a(s.pageX, s.pageY, e, r) || 0;
            (clearTimeout(this.mouseDownTimeout),
                o < i.mouse
                    ? document.removeEventListener('mousemove', this[y])
                    : l >= n && (document.removeEventListener('mousemove', this[y]), this[b]()));
        }
        [v](t) {
        ...
        [L](t) {
            ...
            (Object.assign(this, i),
                ...
                o < n.touch
                    ...
                    : c >= e && (document.removeEventListener('touchmove', this[L]), this[D]()));
        }
        [x](t) {
            if (!this.dragging) return;
            const { pageX: e, pageY: r } = l(t),
                n = document.elementFromPoint(e - window.scrollX, r - window.scrollY),
                s = new d({ clientX: e, clientY: r, target: n, container: this.currentContainer, originalEvent: t });
            this.trigger(this.currentContainer, s);
        }
        [w](t) {
            if (
            ...
            const { pageX: e, pageY: r } = l(t),
                n = document.elementFromPoint(e - window.scrollX, r - window.scrollY);
            t.preventDefault();
            const s = new u({ clientX: e, clientY: r, target: n, container: this.currentContainer, originalEvent: t });
            (this.trigger(this.currentContainer, s),
                (this.currentContainer = null),
                (this.dragging = !1),
                (this.startEvent = null));
    ...
    var H = Object.freeze({
        ...
        DragSensor: class extends s {
            ...
            [A](t) {
                ...
                const e = document.elementFromPoint(t.clientX, t.clientY),
                    ...
                    n = new d({ clientX: t.clientX, clientY: t.clientY, target: e, container: r, originalEvent: t });
                (this.trigger(r, n),
                    n.canceled() || (t.preventDefault(), (t.dataTransfer.dropEffect = this.options.type)));
            }
            [N](t) {
                if (!this.dragging) return;
                ...
                const e = document.elementFromPoint(t.clientX, t.clientY),
                    r = this.currentContainer,
                    n = new u({ clientX: t.clientX, clientY: t.clientY, target: e, container: r, originalEvent: t });
                (this.trigger(r, n), (this.dragging = !1), (this.startEvent = null), this[P]());
            }
            [z](t) {
                t.preventDefault();
            }
            [Y](t) {
                ...
                const e = t.target;
                if (((this.currentContainer = i(e, this.containers)), !this.currentContainer)) return;
            ...
            [P]() {
                (clearTimeout(this.mouseDownTimeout),
                    ...
                    this.nativeDraggableElement &&
                        ((this.nativeDraggableElement.draggable = !0), (this.nativeDraggableElement = null)),
        ...
        ForceTouchSensor: class extends s {
            ...
            attach() {
                ...
                (document.addEventListener('mousemove', this[q]), document.addEventListener('mouseup', this[j]));
            }
            detach() {
                for (const t of this.containers)
                ...
                (document.removeEventListener('mousemove', this[q]), document.removeEventListener('mouseup', this[j]));
            }
            [I](t) {
    ...
    function Q(t, e, r, n, s, i, o, a, l, c, h) {
        ...
        m.access = u && g ? { get: u, set: g, has: f } : u ? { get: u, has: f } : { set: g, has: f };
        try {
            return t.call(e, l, m);
        } finally {
            p.v = !0;
    ...
    function et(t, e) {
        ...
        if (1 === t) {
            ...
            throw new TypeError(
                (0 === t ? 'field' : 5 === t ? 'class' : 'method') + ' decorators must return a function or void 0',
            );
        }
    }
    function rt(t) {
    ...
    function st(t, e, r, n, s, i, o, a, l, c, h) {
        ...
        for (var b = n ? 2 : 1, y = f.length - 1; y >= 0; y -= b) {
            var E;
            void 0 !== (m = Q(f[y], n ? f[y - 1] : void 0, s, d, l, i, o, a, g, c, h)) &&
                (et(i, m),
                0 === i
                    ? (E = m)
                    : 1 === i
                      ? ((E = m.init), (p = m.get || g.get), (v = m.set || g.set), (g = { get: p, set: v }))
                      : (g = m),
    ...
    class Ct extends r {
        constructor(t) {
            (yt(super(t)), (this.lastWidth = 0), (this.lastHeight = 0), (this.mirror = null));
        }
        attach() {
            this.draggable
        ...
        resize(t) {
            requestAnimationFrame(() => {
                ...
                (this.mirror.parentNode !== r && r.appendChild(this.mirror), t.type === ut.type && (e = t.over));
    ...
    class Nt extends r {
        constructor(t) {
            (Tt(super(t)), (this.options = { ...At, ...this.getOptions() }), (this.lastAnimationFrame = null));
        }
        attach() {
    ...
    function zt(t, e, { duration: r, easingFunction: n, horizontal: s }) {
        ...
        if (s) {
            ...
            ((t.style.transform = `translate3d(${r}px, 0, 0)`), (e.style.transform = `translate3d(-${r}px, 0, 0)`));
        } else {
            const r = t.offsetHeight;
            ((t.style.transform = `translate3d(0, ${r}px, 0)`), (e.style.transform = `translate3d(0, -${r}px, 0)`));
        }
        requestAnimationFrame(() => {
            for (const s of [t, e])
    ...
    var qt = Object.freeze({
        ...
        Collidable: class extends r {
            ...
            [V](t) {
                ...
                const r = new U({ dragEvent: t, collidingElement: this.currentlyCollidingElement }),
                    n = new W({ dragEvent: t, collidingElement: this.lastCollidingElement }),
                    s = Boolean(
                ...
                (s
                    ? (this.lastCollidingElement && this.draggable.trigger(n), this.draggable.trigger(r))
        ...
        SortAnimation: class extends r {
            ...
            attach() {
                (this.draggable.on('sortable:sort', this[$t]), this.draggable.on('sortable:sorted', this[It]));
            }
            detach() {
                (this.draggable.off('sortable:sort', this[$t]), this.draggable.off('sortable:sorted', this[It]));
            }
            getOptions() {
            ...
            [It]({ oldIndex: t, newIndex: e }) {
                ...
                const r = [];
                let n, s, i;
                t > e ? ((n = e), (s = t - 1), (i = 1)) : ((n = t + 1), (s = e), (i = -1));
                for (let t = n; t <= s; t++) {
    ...
    function me({ sensorEvent: t, sourceRect: e, options: r, ...n }) {
        return ye((s) => {
            ...
            s({ sensorEvent: t, sourceRect: e, mirrorOffset: { top: i, left: o }, options: r, ...n });
        });
    }
    ...
    function be({ withFrame: t = !1, initial: e = !1 } = {}) {
        return ({
            ...
            ye(
                (t) => {
                    const m = { mirror: r, sensorEvent: n, mirrorOffset: s, options: l, ...g };
                    if (s) {
                        const t = c
                                ? Math.round((n.clientX - s.left - a.x) / (l.thresholdX || 1)) * (l.thresholdX || 1)
                                : Math.round(d),
                            g = h
                                ? Math.round((n.clientY - s.top - a.y) / (l.thresholdY || 1)) * (l.thresholdY || 1)
                                : Math.round(u);
                        ((l.xAxis && l.yAxis) || e
                            ? (r.style.transform = `translate3d(${t}px, ${g}px, 0)`)
                            : l.xAxis && !l.yAxis
                              ? (r.style.transform = `translate3d(${t}px, ${i}px, 0)`)
                              : l.yAxis && !l.xAxis && (r.style.transform = `translate3d(${o}px, ${g}px, 0)`),
    ...
    class Le {
        ...
        off(t, e) {
            ...
            for (let n = 0; n < r.length; n++) e === r[n] && this.callbacks[t].splice(n, 1);
            return this;
        }
        trigger(t) {
            ...
            return (r.length && console.error(`Draggable caught errors while triggering '${t.type}'`, r), this);
        }
    }
    class Oe extends e {
        get draggable() {
    ...
    class $e {
        ...
        removePlugin(...t) {
            return (
                this.plugins.filter((e) => t.includes(e.constructor)).forEach((t) => t.detach()),
        ...
        removeSensor(...t) {
            return (
                this.sensors.filter((e) => t.includes(e.constructor)).forEach((t) => t.detach()),
        ...
        [Ye](t) {
            ...
            if (this.options.handle && r && !i(r, this.options.handle)) return void e.cancel();
            ...
            if ((this.trigger(o), (this.dragging = !o.canceled()), o.canceled()))
                return (this.source.remove(), void (this.originalSource.style.display = null));
        ...
        [Te](t) {
            ...
            (this.trigger(s), s.canceled() && e.cancel(), (n = i(n, this.options.draggable)));
    ...
    (($e.Plugins = {
        Announcement: class extends r {
            ...
            [Ht](t) {
                ...
                (e && 'string' == typeof e && this[Rt](e), e && 'function' == typeof e && this[Rt](e(t)));
            }
            [Rt](t) {
                !(function (t, { expire: e }) {
        ...
        Focusable: class extends r {
            ...
            detach() {
                (this.draggable.off('draggable:initialize', this[Vt]).off('draggable:destroy', this[Gt]), this[Gt]());
            }
            getOptions() {
        ...
        Mirror: class extends r {
            ...
            [ie](t) {
                ...
                const i = new Qt({ source: e, originalSource: r, sourceContainer: n, sensorEvent: s, dragEvent: t });
                if (
                ...
                (this.draggable.trigger(a), o.appendChild(this.mirror), this.draggable.trigger(l));
            }
            [oe](t) {
            ...
            [ae](t) {
                if (
                    ('ontouchstart' in window && document.removeEventListener('scroll', this[he], !0),
                ...
                const { source: e, sourceContainer: r, sensorEvent: n } = t,
                    s = new se({ source: e, mirror: this.mirror, sourceContainer: r, sensorEvent: n, dragEvent: t });
        ...
        Scrollable: class extends r {
            ...
            [Ce](t) {
                ...
                ('ontouchstart' in window &&
                    ...
                    (this.currentMousePosition = { clientX: e.clientX - r.x, clientY: e.clientY - r.y }),
    ...
    const Qe = {
        ...
        tr = { 'droppable:active': 'draggable-dropzone--active', 'droppable:occupied': 'draggable-dropzone--occupied' },
    ...
    const Cr = {
        'sortable:sorted': function ({ dragEvent: t }) {
            ...
            if (t.over) {
                ...
                return t.source.compareDocumentPosition(t.over) & Node.DOCUMENT_POSITION_FOLLOWING
                    ? `Placed ${e} after ${r}`
                    : `Placed ${e} before ${r}`;
            }
    ...
    ((t.BaseEvent = e),
        ...
        (t.Droppable = class extends $e {
            ...
            [We](t) {
                ...
                e && !e.classList.contains(this.getClassNameFor('droppable:occupied')) && this[Ge](t, e)
                    ? (this.lastDropzone = e)
            ...
            [Ve](t) {
                const e = new Re({ dragEvent: t, dropzone: this.lastDropzone || this.initialDropzone });
                this.trigger(e);
                const r = this.getClassNamesFor('droppable:occupied');
                for (const t of this.dropzones) t.classList.remove(...this.getClassNamesFor('droppable:active'));
                (this.lastDropzone &&
        ...
        (t.Sortable = class extends $e {
            constructor(t = [], e = {}) {
                (super(t, { ...e, announcements: { ...Cr, ...(e.announcements || {}) } }),
            ...
            getSortableElementsForContainer(t) {
                return [...t.querySelectorAll(this.options.draggable)].filter(
                    (e) => e !== this.originalSource && e !== this.mirror && e.parentNode === t,
                );
            }
            [fr](t) {
                ((this.startContainer = t.source.parentNode), (this.startIndex = this.index(t.source)));
                const e = new gr({ dragEvent: t, startIndex: this.startIndex, startContainer: this.startContainer });
            ...
            [br](t) {
                ...
                const { oldContainer: a, newContainer: l } = o,
                    ...
                    h = new pr({ dragEvent: t, oldIndex: s, newIndex: c, oldContainer: a, newContainer: l });
                this.trigger(h);
            }
            [yr](t) {
        ...
        (t.Swappable = class extends $e {
            ...
            [lr](t) {
                ...
                const e = new sr({ dragEvent: t, over: t.over, overContainer: t.overContainer });
