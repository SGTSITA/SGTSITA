            ...
            var s = $(r),
                ...
                f = {
                        ...
                        switch (e) {
                            ...
                            case 'language':
                                ...
                                'string' == typeof n.captions &&
                                    (n.captions in l
                                        ...
                                        : (n.captions = $.extend(!0, {}, $.fn.fileuploader.defaults.captions)));
                                break;
                            case 'disabled':
                                ((f.disabled = t),
                            ...
                            case 'feedback':
                                ((t =
                                    t ||
                                    f._assets.textParse(
                                        0 < f._itFl.length ? n.captions.feedback2 : n.captions.feedback,
                                        {
                            ...
                            case 'nextInput':
                                ...
                                (f.bindUnbindEvents(!1),
                                    0 < sl.length && 0 == sl[sl.length - 1].get(0).files.length
                                        ? (s = sl[sl.length - 1])
                                        : (-1 == sl.indexOf(s) && sl.push(s), sl.push(d), s.after((s = d))),
                                    f.bindUnbindEvents(!0));
                                break;
                            case 'listInput':
                            ...
                            for (var r = 0, a = 0; a < i.length; a++) {
                                ...
                                if (!0 === c)
                                    ...
                                    c[2] ||
                                        ...
                                        c[1] && f._assets.dialogs.alert(c[1], u, l, p, o, s)),
                                    c[3])
                                )
                                    break;
                            }
                                        ...
                                        : f.files.read(
                                              ...
                                              function () {
                                                  r(
                                                      d.reader.frame ||
                                                          (d.reader.node &&
                                                          'img' == d.reader.node.nodeName.toLowerCase()
                                                              ? d.reader.src
                                                              : null),
                                                      !0,
                                                  );
                    ...
                    editor: {
                                                ...
                                                step: function (e, t) {
                                                    ...
                                                    ('none' !== r &&
                                                        ...
                                                        (a =
                                                            'rotation' == s
                                                                ? e
                                                                : Math.round(Math.atan2(n, i) * (180 / Math.PI))),
                                                        (l =
                                                            'scale' == s
                                                                ? e
                                                                : Math.round(10 * Math.sqrt(i * i + n * n)) / 10)),
                                                        p.css({
                                                            '-webkit-transform':
                                                                'rotate(' + a + 'deg) scale(' + l + ')',
                        ...
                        crop: function (w, e) {
                            var t, l, o;
                            if (!(w.popup && w.popup.html && $('html').find(w.popup.html).length))
                                      ...
                                      (w.popup.editor.cropper = {
                                          ...
                                          init: function (o) {
                                              var i = w.popup.editor.cropper,
                                                  ...
                                                  a =
                                                      ...
                                                      -1 < [90, 270].indexOf(w.popup.editor.rotation)
                                          ...
                                          resize: function (e) {
                                              ...
                                              0 < i.width() &&
                                                  (e
                                                      ...
                                                      : ((o.crop.cfWidth = i.width() / w.reader.width),
                                                        (o.crop.cfHeight = i.height() / w.reader.height)));
                                          },
                                          ...
                                          mousemove: function (e) {
                                                  ...
                                                  b = {
                                                      x:
                                                          ('mousedown' == g
                                                              ? e.pageX
                                                              : e.originalEvent.touches[0].pageX) -
                                                          v.$template.offset().left,
                                                      y:
                                                          ('mousedown' == g
                                                              ? e.pageY
                                                              : e.originalEvent.touches[0].pageY) -
                                                          v.$template.offset().top,
                                                  };
                                              ...
                                              (v.isMoving &&
                                                  ...
                                                  t + v.crop.width > v.$template.width() &&
                                                      (t = v.$template.width() - v.crop.width),
                                                  t < 0 && (t = 0),
                                                  o + v.crop.height > v.$template.height() &&
                                                      (o = v.$template.height() - v.crop.height),
                                                  o < 0 && (o = 0),
                                                  (v.crop.left = t),
                                                  (v.crop.top = o)),
                                                  v.isResizing &&
                                                      ...
                                                      ('a' != i && 'b' != i && 'c' != i) ||
                                                          ...
                                                          v.crop.top > v.crop.top + v.crop.height &&
                                                              ((v.crop.top = a), (v.crop.height = 0)),
                                                          v.crop.height < s &&
                                                              ((v.crop.top = a - s), (v.crop.height = s)),
                                                          v.crop.height > d &&
                                                              ((v.crop.top = a - d), (v.crop.height = d)),
                                                          (c = u
                                                              ? f._assets.ratioToPx(v.crop.width, v.crop.height, u)
                                                              : null) &&
                                                              ((v.crop.width = c[0]),
                                                              ('a' != i && 'b' != i) ||
                                                                  (v.crop.left = Math.max(
                                                                      0,
                                                                      v.pointData.left +
                                                                          (v.pointData.width - v.crop.width) /
                                                                              ('b' == i ? 2 : 1),
                                                                  )),
                                                              v.crop.left + v.crop.width > v.$template.width() &&
                                                                  ((h = v.$template.width() - v.crop.left),
                                                                  (v.crop.width = h),
                                                                  (v.crop.height = (h / c[2]) * c[3]),
                                                                  (v.crop.top = a - v.crop.height)))),
                                                      ('e' != i && 'f' != i && 'g' != i) ||
                                                          c ||
                                                          ((v.crop.height = b.y - v.crop.top),
                                                          v.crop.height + v.crop.top > v.$template.height() &&
                                                              (v.crop.height = v.$template.height() - v.crop.top),
                                                      ...
                                                      ('c' != i && 'd' != i && 'e' != i) ||
                                                          ...
                                                          v.crop.width + v.crop.left > v.$template.width() &&
                                                              (v.crop.width = v.$template.width() - v.crop.left),
                                                          ...
                                                          (c = u
                                                              ...
                                                              ('c' != i && 'd' != i) ||
                                                                  (v.crop.top = Math.max(
                                                                      0,
                                                                      v.pointData.top +
                                                                          (v.pointData.height - v.crop.height) /
                                                                              ('d' == i ? 2 : 1),
                                                                  )),
                                                              v.crop.top + v.crop.height > v.$template.height() &&
                                                                  ((m = v.$template.height() - v.crop.top),
                                                                  (v.crop.height = m),
                                                                  (v.crop.width = (m / c[3]) * c[2])))),
                                                      ('a' != i && 'g' != i && 'h' != i) ||
                                                          c ||
                                                          ((v.crop.left = b.x),
                                                          ...
                                                          v.crop.left > v.crop.left + v.crop.width &&
                                                              ((v.crop.left = r), (v.crop.width = 0)),
                                                          v.crop.width < l &&
                                                              ((v.crop.left = r - l), (v.crop.width = l)),
                                                          v.crop.width > p &&
                                                              ((v.crop.left = r - p), (v.crop.width = p)),
                                                          (c = u
                                                              ? f._assets.ratioToPx(v.crop.width, v.crop.height, u)
                                                              : null) &&
                                                              ((v.crop.height = c[1]),
                                    ...
                                    (s.popup.zoomer = {
                                            ...
                                            var t = this,
                                                ...
                                                i = e
                                                    ? ((o = t.left),
                                                      ...
                                                      d.width() <= p.width() &&
                                                          (o = Math.round((p.width() - d.width()) / 2)),
                                                      d.height() <= p.height() &&
                                                          (i = Math.round((p.height() - d.height()) / 2)),
                                                      d.width() > p.width() &&
                                                          (0 < o
                                                              ? (o = 0)
                                                              : o + d.width() < p.width() &&
                                                      ...
                                                      Math.min(i, 0))
                                                    : ((o = Math.round((p.width() - d.width()) / 2)),
                                                      Math.round((p.height() - d.height()) / 2));
                                            d.css({
                                                left: (t.left = o) + 'px',
                                                top: (t.top = i) + 'px',
                                                width: d.width(),
                                        ...
                                        mousemove: function (e) {
                                            ...
                                            (0 < a && (a = 0),
                                                ...
                                                d.width() > p.width()
                                                    ? (0 < r && (r = 0),
                                                      r < p.width() - d.width() && (r = p.width() - d.width()))
                                                    : (r = p.width() / 2 - d.width() / 2),
                                                d.css({
                                                    left: (t.left = r) + 'px',
                                                    top: (t.top = a) + 'px',
                                                }));
                                        ...
                                        n.editor.maxWidth || n.editor.maxHeight
                                            ? (((g = new Image()).src = v),
                                              (g.onload = function () {
                                                  ...
                                                  (f.editor.resize(g, e, n.editor.maxWidth, n.editor.maxHeight, !0, !1),
                                                      (v = e.toDataURL(c, h / 100)),
                                                      (a = d = e = null),
                                                      m(v, g));
                                              }))
                                            : ((a = d = null), m(v));
                            ...
                            if (t) {
                                ...
                                ((b.editor.rotation = b.popup.editor.rotation || 0),
                                    b.popup.editor.cropper &&
                                        ...
                                        (b.editor.crop.width =
                                            b.editor.crop.width / b.popup.editor.cropper.crop.cfWidth / r),
                                        (b.editor.crop.left =
                                            b.editor.crop.left / b.popup.editor.cropper.crop.cfWidth / r),
                                        (b.editor.crop.height =
                                            b.editor.crop.height / b.popup.editor.cropper.crop.cfHeight / r),
                                        (b.editor.crop.top =
                                            b.editor.crop.top / b.popup.editor.cropper.crop.cfHeight / r)));
                            }
                            f._assets.isMobile()
                            ...
                            function t() {
                                ((f.sorter.sort = {
                                    ...
                                    placeholder: n.sorter.placeholder
                                        ...
                                        : $(a.html.get(0).cloneNode()).addClass('fileuploader-sorter-placeholder'),
                                }),
                                    $('body').css({
                                        '-webkit-user-select': 'none',
                                        '-moz-user-select': 'none',
                            ...
                            return (
                                ...
                                3 == e.which ||
                                    ...
                                    !(
                                        ...
                                        (!i.is(n.sorter.selectorExclude) && !i.closest(n.sorter.selectorExclude).length)
                                    ) ||
                                    (e.preventDefault(),
                                    'mousedown' == o && t(),
                                    'touchstart' == o &&
                        ...
                        send: function (a, e) {
                            if (a.upload) {
                                ...
                                if (n.upload.synchron && !a.upload.chunk)
                                    if (((a.upload.status = 'pending'), a.html && u(), e))
                                        -1 < f._pfuL.indexOf(a) && f._pfuL.splice(f._pfuL.indexOf(a), 1);
                    ...
                    files: {
                                    ...
                                    if (
                                        ((a.onload = function (e) {
                                            function o() {
                                                (d.data &&
                                                    d.data.readerCrossOrigin &&
                                                    p.setAttribute('crossOrigin', d.data.readerCrossOrigin),
                                                    (p.src =
                                                        e.target.result +
                                                    ...
                                                    (p.onload = function () {
                                                        if (d.reader.exifOrientation) {
                                                            ...
                                                            return (
                                                                ...
                                                                n &&
                                                                    (-1 < [-1, -180].indexOf(n)
                                                                        ? (t.translate(e.width, 0), t.scale(-1, 1))
                                                                        : -1 < [-90, -270].indexOf(n) &&
                                                                          (t.translate(0, e.width), t.scale(1, -1))),
                                                                t.drawImage(o, 0, 0),
                                            ...
                                            n.thumbnails.exif && d.choosed
                                                ? f._assets.getExifOrientation(d.file, function (e) {
                                                      var t;
                                                      (e &&
                                                          ('Chrome' == (t = f._assets.getDevice.init()).browser.name &&
                                                          81 <= t.browser.version
                        ...
                        check: function (i, r, e) {
                            ...
                            if (
                                ...
                                (-1 < $.inArray(i.extension, n.disallowedExtensions) ||
                                    n.disallowedExtensions.filter(function (e) {
                                        return (
                                            !i.type.length || -1 < e.indexOf(i.type) || -1 < e.indexOf(i.format + '/*')
                                        );
                                    }).length)
                            )
                                return ((a[1] = f._assets.textParse(n.captions.errors.filesType, i)), a);
                            ...
                            if ((4096 == i.size || 64 == i.size) && '' == i.type)
                                ...
                                i.input &&
                                    ...
                                    a &&
                                        (f.isAddMoreMode() && 1 < sl.length
                                            ? (f.set('nextInput'), sl.splice(sl.indexOf(i.input), 1), i.input.remove())
                                            : f.set('input', ''))),
                    ...
                    _assets: {
                        ...
                        bytesToText: function (e) {
                            ...
                            var t = Math.floor(Math.log(e) / Math.log(1024)),
                                ...
                                i = !1;
                            return (
                                1e3 < o && t < 8 && ((t += 1), (o = e / Math.pow(1024, t)), (i = !0)),
                                o.toPrecision(i ? 2 : 3) +
                                    ' ' +
                        ...
                        textToColor: function (e) {
                            ...
                            for (
                                var t = 0, i = '#';
                                t < 3;
                                i += ('00' + ((o >> (2 * t++)) & 255).toString(16)).slice(-2)
                            );
                            return i;
                        },
                            ...
                            if (navigator.plugins && navigator.plugins.length)
                                for (var t in navigator.plugins)
                                    if (
                                        ...
                                        -1 < navigator.plugins[t].name.toLowerCase().indexOf(e)
                                    )
                                        return !0;
                            return !1;
                        },
                                ...
                                for (var o, i, n, r = 0, a = 0, r = 0; r < t.length; r += 1)
                                    if (new RegExp(t[r].value, 'i').test(e)) {
                                        if (
                                            ...
                                            (n = ''),
                                            (i = e.match(o)) && i[1] && (i = i[1]),
                                            i)
                                        )
                                            for (i = i.split(/[._]+/), a = 0; a < i.length; a += 1)
                                                n += 0 === a ? i[a] + '.' : i[a];
                                        else n = '0';
                                        return {
                                            name: t[r].name,
                    ...
                    (s.get(0).FileUploader = {
                        ...
                        add: function (e, t, o) {
                            return (
                                ...
                                (((n =
                                    e instanceof Blob
                                        ? e
                                        : ((i = /data:[a-z]+\/[a-z]+\;base64\,/.test(e)
                                              ? e
                                              : 'data:' + t + ';base64,' + btoa(e)),
                                          f._assets.dataURItoBlob(i, t)))._name =
                                    o ||
                        ...
                        remove: function (e) {
                            return (
                                ...
                                -1 < f._itFl.indexOf(e) && (f.files.remove(e), !0)
                            );
                        },
        ...
        ($.fn.fileuploader.languages = {
            cz: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Pouze ${limit} ' +
                            (1 == e.limit ? 'soubor může být nahrán' : 'soubory mohou byt nahrané') +
                            '.'
                        );
                    },
            ...
            de: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Nur ${limit} ' + (1 == e.limit ? 'Datei darf' : 'Dateien dürfen') + ' hochgeladen werden.'
                        );
                    },
            ...
            lv: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Tikai ${limit} ' +
                            (1 == e.limit ? 'failu var augšupielādēt' : 'failus var augšupielādēt') +
                            '.'
                        );
                    },
            ...
            pt: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Apenas ${limit} ' +
                            (1 == e.limit ? 'arquivo a ser carregado' : 'arquivos a serem carregados') +
                            '.'
                        );
                    },
            ...
            ro: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Doar ${limit} ' +
                            (1 == e.limit ? 'fișier poate fi selectat' : 'fișiere pot fi selectat') +
                            '.'
                        );
                    },
            ...
            ru: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Только ${limit} ' +
                            (1 == e.limit ? 'файл может быть загружен' : 'файлов могут быть загружены') +
                            '.'
                        );
                    },
            ...
            tr: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            'Sadece ${limit} ' + (1 == e.limit ? 'dosya' : 'dosyalar') + ' yüklenmesine izin verilir.'
                        );
                    },
