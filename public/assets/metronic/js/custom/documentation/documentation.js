        ...
        init: function (i) {
            ...
            ((e = document.querySelector('#kt_docs_aside_menu_wrapper')),
                ...
                e &&
                    ...
                    e.scroll({ top: KTUtil.getRelativeTopPosition(c, e), behavior: 'smooth' }),
                t &&
                    ((function () {
                        function e(e) {
                            return null == e
                        ...
                        ([].slice.call(document.querySelectorAll('[data-kt-keenicons-style-toggle="true"]')),
                            KTUtil.on(
                                document.body,
                            ...
                            KTUtil.on(document.body, '[data-kt-icon-use="true"]', 'click', function (t) {
                                var i = document.querySelector('[data-kt-keenicons-style-toggle="true"]:checked').value,
                                    c = this.closest('[data-kt-icon-preview="true"]').querySelector(
                            ...
                            document.getElementById('kt_keenicons_use').addEventListener('show.bs.modal', (e) => {
                                ((document.querySelector('#kt_keenicons_use_title').innerHTML = n),
                                    (document.querySelector('#kt_keenicons_use_code').innerHTML = o));
                            }));
                    })(),
                    (function () {
