    ...
    function (t, e, r) {
        ...
        t.exports = function (t, e) {
            ...
            var r = {
                search: function (n, i) {
                    for (
                        var s = e.multiSearch ? n.replace(/ +$/, '').split(/ +/) : [n], a = 0, o = t.items.length;
                        a < o;
                        a++
                    )
                ...
                (this.remove = function (t, e, r) {
                    for (var n = 0, i = 0, s = v.items.length; i < s; i++)
                        v.items[i].values()[t] == e &&
                            (v.templater.remove(v.items[i], r), v.items.splice(i, 1), s--, i--, n++);
                    return (v.update(), n);
                }),
            ...
            var e = function (e, i) {
                ...
                r = {
                    ...
                    dottedRight: function (t, e, r, n, i, s, a) {
                        return (
                            !t.items[a - 1].values().dotted && e == n && !this.innerWindow(e, i, s) && !this.right(e, n)
                        );
                    },
                },
                a = function (e, r, n) {
            ...
            var e,
                ...
                a = {
                    ...
                    values: function (r, i) {
                        return !!(
                            r.hasOwnProperty(i) &&
                            ((e = t.utils.toString(r[i]).toLowerCase()), '' !== n && e.search(n) > -1)
                        );
                    },
                    reset: function () {
