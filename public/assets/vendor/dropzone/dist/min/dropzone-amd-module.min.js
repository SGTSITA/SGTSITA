                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                for (
                                    var b = this.events, c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();
                                    ;
                                ) {
                                    var e;
                                    if (c) {
                        ...
                        },
                        {
                            ...
                            value: function (a, b, c, d, e) {
                                ...
                                return this.createThumbnail(a, b, c, d, !0, function (b, c) {
                                    ...
                                    return (
                                        ('image/jpeg' !== d && 'image/jpg' !== d) || (h = o.restore(a.dataURL, h)),
                                        e(g.dataURItoBlob(h))
                                    );
                                });
                            },
                                    ...
                                    for (
                                        ...
                                        if ((h && (h = h.toLowerCase()), void 0 !== g && null !== g))
                                            if ('SELECT' === f.tagName && f.hasAttribute('multiple'))
                                                ...
                                                (!h || ('checkbox' !== h && 'radio' !== h) || f.checked) &&
                                                    a.append(g, f.value);
                                    }
                            },
                        },
                            ...
                            value: function (a, b, c) {
                                ...
                                if (void 0 !== c) {
                                    if (((d = (100 * c.loaded) / c.total), a[0].upload.chunked)) {
                                        ...
                                        for (
                                            var h = a, i = Array.isArray(h), j = 0, h = i ? h : h[Symbol.iterator]();
                                            ;
                                        ) {
                                            var k;
                                            if (i) {
                                    ...
                                    for (var s = a, t = Array.isArray(s), u = 0, s = t ? s : s[Symbol.iterator](); ; ) {
                                        ...
                                        var w = v;
                                        ((100 === w.upload.progress && w.upload.bytesSent === w.upload.total) ||
                                            (r = !1),
                                            (w.upload.progress = d),
        ...
        (j.isBrowserSupported = function () {
            ...
            if (
                ...
                if ('classList' in document.createElement('a'))
                    for (
                        var b = j.blacklistedBrowsers, c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();
                        ;
                    ) {
                        var e;
                        if (c) {
    ...
    ((j.createElement = function (a) {
        ...
        (j.getElements = function (a, b) {
            ...
            if (a instanceof Array) {
                ...
                d = [];
                for (
                    var h = document.querySelectorAll(a), i = Array.isArray(h), j = 0, h = i ? h : h[Symbol.iterator]();
                    ;
                ) {
                    if (i) {
                        if (j >= h.length) break;
