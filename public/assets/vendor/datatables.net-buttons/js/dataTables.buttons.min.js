...
(function (d) {
            ...
            var c = [],
                ...
                i = function (a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d) {
                        ...
                        'object' === typeof a &&
                            a.nodeName &&
                            ((f = d.inArray(a, h)), -1 !== f && c.push({ inst: b, node: h[f] }));
                },
                g = 0,
                f = a.length;
            g < f;
    ...
    j.Api.registerPlural('buttons().containers()', 'buttons().container()', function () {
        ...
        this.iterator(!0, 'table', function (c) {
            if (c._buttons)
                for (var c = m.instanceSelector(b, c._buttons), d = 0, i = c.length; d < i; d++)
    ...
    j.Api.register('buttons.exportInfo()', function (a) {
        ...
        var c = a;
        b =
            '*' === c.filename && '*' !== c.title && c.title !== n && null !== c.title && '' !== c.title
                ? c.title
                : c.filename;
