        ...
        init: function (b) {
            ...
            (a.each(i, function (b, f) {
                        ...
                        return (
                            c ||
                                ('x' === b && a.originalEvent.deltaX
                                    ...
                                    : 'y' === b && a.originalEvent.deltaY && (c = 40 * a.originalEvent.deltaY)),
                            ((c > 0 && p < g) || (c < 0 && p > 0)) &&
                                ((p += c),
                                p < 0 && (p = 0),
                                p > g && (p = g),
                ...
                a.each(i, function (a, b) {
                    ...
                    (h.autoScrollSize &&
                        ((b.scrollbarSize = parseInt((k * j) / i, 10)), b.scroll.bar.css(f, b.scrollbarSize + 'px')),
        ...
        _updateScroll: function (b, d) {
            ...
            ((d.isVisible = k - l > 1),
                d.isVisible
                    ...
                    : (d.scroll.removeClass(g), h.scroll.removeClass(g), f.removeClass(g)),
                'y' === b &&
                    (e.is('textarea') || k < l
                        ? f.css({ height: l + c.scroll.height + 'px', 'max-height': 'none' })
                ...
                ((j = c.scrolls[f]),
                    ...
                    (e ||
                        ...
                        i.debug &&
                            ...
                            d++)));
            b && d > 10
                ? (window.console && console.log('Scroll updates exceed 10'), (g = function () {}))
