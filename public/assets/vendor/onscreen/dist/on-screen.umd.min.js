!(function (global, factory) {
    ...
    function inContainer(el) {
        ...
        if (
            ('string' == typeof el && (el = document.querySelector(el)),
            'string' == typeof options && (options = { tolerance: 0, container: document.querySelector(options) }),
            'string' == typeof options.container && (options.container = document.querySelector(options.container)),
            options instanceof HTMLElement && (options = { tolerance: 0, container: options }),
            !options.container)
        )
    ...
    function eventHandler() {
        ...
        selectors.length &&
            ((testVisibility = options.container === window ? inViewport : inContainer),
    ...
    function on(event, selector, callback) {
        ...
        'function' == typeof callback &&
            (this.trackedElements[selector][event] || (this.trackedElements[selector][event] = {}),
                    ...
                    get: function () {
                        ...
                        return (
                            'string' == typeof options.container
                                ...
                                : options.container instanceof HTMLElement && (container = options.container),
                            container || window
                        );
                    },
                    set: function (value) {
    ...
    return (
        Object.defineProperties(OnScreen.prototype, {
            _debouncedScroll: { configurable: !1, writable: !1, enumerable: !1, value: debouncedScroll },
