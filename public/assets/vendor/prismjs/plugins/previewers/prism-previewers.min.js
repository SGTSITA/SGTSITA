                        ...
                        (s = function (e) {
                            ...
                            return 0 <= t.indexOf('linear')
                                ? (r[e] = (function (e, s, i) {
                                      var t = '180deg';
                                      return (
                                          /^(?:-?\d*\.?\d+(?:deg|rad)|to\b|top|right|bottom|left)/.test(i[0]) &&
                        ...
                        new Prism.plugins.Previewer(
                            ...
                            function (e) {
                                ...
                                return (
                                    (i = (100 * t) / s),
                                    (i %= 100),
                                    this[(t < 0 ? 'set' : 'remove') + 'Attribute']('data-negative', ''),
                    ...
                    create: function () {
                        new Prism.plugins.Previewer(
                            ...
                            function (e) {
                                ...
                                return (
                                    !(!s || !i) &&
                                    ((i = i[0]), (this.querySelector('circle').style.animationDuration = 2 * s + i), !0)
                                );
                            },
                            '*',
                            function () {
