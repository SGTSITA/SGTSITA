var components = {
    ...
    languages: {
        meta: { path: 'components/prism-{id}', noCSS: true, examplesPath: 'examples/prism-{id}', addCheckAll: true },
        markup: {
            title: 'Markup',
        ...
        actionscript: { title: 'ActionScript', require: 'javascript', peerDependencies: 'markup', owner: 'Golmote' },
        ...
        n4js: { title: 'N4JS', require: 'javascript', peerDependencies: ['jsdoc'], alias: 'n4jsd', owner: 'bsmith-n4' },
