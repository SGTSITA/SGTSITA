    ...
    ((String.format = function () {
        ...
        a.extend(b.prototype, {
                ...
                (this.buildNotify(),
                    ...
                    (this.notify = {
                        ...
                        update: function (b, c) {
                            ...
                            var g =
                                this.$ele.outerHeight() + parseInt(a.settings.spacing) + parseInt(a.settings.offset.y);
                            a.reposition(g);
                        },
                        close: function () {
                            a.close();
            ...
            buildNotify: function () {
                ...
                ((this.$ele = a(
                    String.format(this.settings.template, this.settings.type, b.title, b.message, b.url, b.target),
                )),
                    this.$ele.attr(
            ...
            placement: function () {
                ...
                (this.$ele.css(d).addClass(this.settings.animate.enter),
                    ...
                    1 == this.settings.newest_on_top &&
                        ((c = parseInt(c) + parseInt(this.settings.spacing) + this.$ele.outerHeight()),
                        this.reposition(c)),
