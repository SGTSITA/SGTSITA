...
(function (n) {
    ...
    var i = { space: 32, pageup: 33, pagedown: 34, end: 35, home: 36, up: 38, down: 40 },
        r = function (t, i) {
            ...
            return (
                t.type === 'wheel'
                    ? ((e = i.height() / n(window).height()), (r = t.originalEvent.deltaY * e))
                    : this.options.touch &&
                      t.type === 'touchmove' &&
        ...
        u = function (n, t) {
            var u = t.scrollTop(),
                ...
                e;
            return (
                (r.top = u === 0 && (n.keyCode === i.pageup || n.keyCode === i.home || n.keyCode === i.up)),
                r.top ||
        ...
        wheelEventName:
            'onwheel' in document.createElement('div')
                ...
                : document.onmousewheel !== undefined
                  ...
                  : 'DOMMouseScroll',
        animationEventName:
            ['webkitAnimationEnd', 'mozAnimationEnd', 'MSAnimationEnd', 'oanimationend', 'animationend'].join(
                t.ANIMATION_NAMESPACE + ' ',
            ) + t.ANIMATION_NAMESPACE,
